...
フェニック木を抽象化することで様々なことができますが、セグメント木でもできることが多いのでそこまで注目されておらず、逆元の存在や可換性が常に必要であると思い込まれがちなようです。

ここでは各種抽象化フェニック木にできることをまとめていこうと思います。具体的な実装は様々な解説で説明されていると思うので、ここではあくまでできることのまとめに徹しようと思います。
