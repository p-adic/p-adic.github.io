...
- 固定した全順序集合とその$\max$演算の組
  ...
  - 固定した全順序集合$P$に対する、$P$値有限列の集合とその辞書式順序に関する$\max$演算の組
    - 固定した非負整数$L$に対する、整数係数$L$次元ベクトル全体の集合とその辞書式順序に関する$\max$演算の組
    - 文字列全体の集合とその辞書式順序に関する$\max$演算の組
- 固定した全順序集合とその$\min$演算の組
  ...
  - 固定した全順序集合$P$に対する、$P$値有限列の集合とその辞書式順序に関する$\min$演算の組
    - 固定した非負整数$L$に対する、整数係数$L$次元ベクトル全体の集合とその辞書式順序に関する$\min$演算の組
    - 文字列全体の集合とその辞書式順序に関する$\min$演算の組
- 整数全体の集合とその$\gcd$演算の組
