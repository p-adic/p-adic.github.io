...
畳み込み積に関して$v \in K^N$との内積$K^N \to K$が環準同型である必要十分条件は、$v$が$G$の指標である時です。指標について知らない人はあまり気にせずこの章を飛ばして、次に説明する巡回畳み込みとbitwise XOR畳み込みで指標の具体例を見てください。

さて$G$の指標達は自動的に線形独立です。このことは$K = \mathbb{Q},\mathbb{R},\mathbb{C}$で$G$が有限群であればユニタリー指標の直交性をもとに理解している人も多いかと思いますが、一般の場合でもファンデルモンド行列式と同様の計算で確認できます。
