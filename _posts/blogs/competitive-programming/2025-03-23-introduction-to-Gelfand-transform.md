...
ちなみに今回は$D$個の命題変数$P_1,\ldots,P_D$から作った具体的なブール代数を考えましたが、一般のブール代数でも同様の議論ができることが[ストーンの表現定理](https://ja.wikipedia.org/wiki/ストーンの表現定理)により保証されます。[ストーン双対](https://ja.wikipedia.org/wiki/ストーン双対性)を知っている人向けに言うと、ブール代数に対するストーン双対もまたゲルファント変換とみなせるということです。
