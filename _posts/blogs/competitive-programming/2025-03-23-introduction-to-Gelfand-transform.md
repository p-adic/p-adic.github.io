...
つまり、離散フーリエ変換はゲルファント変換の特別なものということです。離散フーリエ変換の高速化がどのような時にできるかの話をするにはポントリャーギン双対の話をすると良いのですが、その前に一旦具体例を２つ紹介します。
...
ポントリャーギン双対の生成系に、再帰と相性の良い構造を見つけられるか否かという問題なわけですね。次の多項式乗算の例で、高速フーリエ変換と高速アダマール変換以外にも実際に高速化できる例があることを説明いたします。
