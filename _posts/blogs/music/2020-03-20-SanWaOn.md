...
\\]
となります。このことから、$$\textrm{GetOnMei}$$はwell-definedな写像$$\overline{\textrm{SanWaOn}} \times \{0,1,2\} \to \textrm{OnMei}$$を誘導しないことが分かります。その意味で「$$3$$和音の$$1$$番目の音名」はill-definedな概念となります。代わりに後に導入する「$$3$$和音の配置の$$1$$番目のピッチ」等はwell-definedとなります。
