...
\\]
に属する文字列を***ピッチ***と呼びます。例えば文字列$$\textrm{La}4$$は組$$(\textrm{La},4)$$と同一視され、更に[音名の記事]({{ site.url }}/OnMei/)で述べたように文字列$$\textrm{La}$$は組$$(\textrm{La},\textrm{□})$$と同一視され、$$(\textrm{La},\textrm{□})$$は音名であることから$$\textrm{La}4$$はピッチとなります。
