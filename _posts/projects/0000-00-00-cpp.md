...
- [数学用ライブラリ](https://github.com/p-adic/cpp/tree/master/Mathematics)
  ...
  - [組み合わせ論](https://github.com/p-adic/cpp/tree/master/Mathematics/Combinatorial)
    - [数え上げ](https://github.com/p-adic/cpp/tree/master/Mathematics/Combinatorial/Enumeration)
      - [多次元配列、階乗、場合の数](https://github.com/p-adic/cpp/tree/master/Mathematics/Combinatorial/Enumeration/VLArray)
  ...
  - [グラフ](https://github.com/p-adic/cpp/tree/master/Mathematics/Graph)
    - [ホップクロフトカープ](https://github.com/p-adic/cpp/tree/master/Mathematics/Graph/HopcroftKarp)
...
- [汎用ライブラリ](https://github.com/p-adic/cpp/tree/master/Utility)
  ...
  - [探索ライブラリ](https://github.com/p-adic/cpp/tree/master/Utility/Search)
    - [幅優先探索](https://github.com/p-adic/cpp/tree/master/Utility/Search/BreadthFirst)
      - [bit全探索](https://github.com/p-adic/cpp/tree/master/Utility/Search/BreadthFirst/BitExhausiveSearch)
    - [深さ優先探索](https://github.com/p-adic/cpp/tree/master/Utility/Search/DepthFirst)
      - [木の深さ優先探索](https://github.com/p-adic/cpp/tree/master/Utility/Search/DepthFirst/Tree)
    - [ダイクストラ](https://github.com/p-adic/cpp/tree/master/Utility/Search/Dijkstra)
    - [ワーシャルフロイド](https://github.com/p-adic/cpp/tree/master/Utility/Search/FloydWarshall)
