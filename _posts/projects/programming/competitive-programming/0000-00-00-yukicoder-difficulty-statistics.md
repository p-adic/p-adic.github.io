...
通常問題の問題番号2056から2500まで登録し終わりました。先は長いです。
...
1. （★2.3／diff <font color="deepskyblue">1510</font>／15問）<a href="#ソート" class="tag">ソート</a>
...
1. （★2.5／diff <font color="blue">1794</font>／22問）<a href="#二分探索" class="tag">二分探索</a>
...
1. （★3／diff <font color="red">3018</font>／1問、[解説ページ](https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#指定序数の値の計算を各値未満の数え上げに帰着)）<a href="#指定序数の値の計算を各値未満の数え上げに帰着" class="tag">指定序数の値の計算を各値未満の数え上げに帰着</a>
1. （★3／diff <font color="red">3018</font>／1問）<a href="#約数ゼータ変換" class="tag">約数ゼータ変換</a>
1. （★3.1／diff <font color="yellowgreen">2196</font>／5問）<a href="#付値管理" class="tag">付値管理</a>
...
　
<h2 id="不定方程式の因数分解">64. 不定方程式の因数分解</h2>
...
　
<h2 id="階乗を用いた二項係数計算">68. 階乗を用いた二項係数計算</h2>
...
　
<h2 id="マッチ度ごとに管理">70. マッチ度ごとに管理</h2>
...
- 全体: ★2.3／diff <font color="deepskyblue">1510</font>
- 2024年: ★データなし／diffデータなし
- 2023年: ★2.1／diff <font color="deepskyblue">1319</font>
...
　
<h2 id="等比数列の累積和計算">74. 等比数列の累積和計算</h2>
...
　
<h2 id="最終ターン数に注目">84. 最終ターン数に注目</h2>
...
　
<h2 id="区間を切片の差に翻訳">87. 区間を切片の差に翻訳</h2>
...
　
<h2 id="$\ell^1$距離から$\ell^{\infty}$距離への変換">100. $\ell^1$距離から$\ell^{\infty}$距離への変換</h2>
...
　
<h2 id="符号全探索による絶対値計算">102. 符号全探索による絶対値計算</h2>
...
　
<h2 id="言及する成分数を最大化する質問">104. 言及する成分数を最大化する質問</h2>
...
　
<h2 id="倍数メビウス変換">106. 倍数メビウス変換</h2>
...
　
<h2 id="区間和の指定された区間計算">109. 区間和の指定された区間計算</h2>
...
　
<h2 id="最大・最小要素削除">114. 最大・最小要素削除</h2>
...
　
<h2 id="始切片の数え上げを桁ごとの計算に帰着">116. 始切片の数え上げを桁ごとの計算に帰着</h2>
...
　
<h2 id="上限・下限値に言及する質問">118. 上限・下限値に言及する質問</h2>
...
　
<h2 id="価値上限ありナップサック最適化">122. 価値上限ありナップサック最適化</h2>
...
　
<h2 id="重複選択可価値上限ありナップサック最適化">123. 重複選択可価値上限ありナップサック最適化</h2>
...
- 全体: ★2.5／diff <font color="blue">1794</font>
- 2024年: ★データなし／diffデータなし
- 2023年: ★2.4／diff <font color="blue">1699</font>
...
　
<h2 id="合成数を法とする逆元のオイラーの定理による計算">130. 合成数を法とする逆元のオイラーの定理による計算</h2>
...
　
<h2 id="１次式の累積和計算">133. １次式の累積和計算</h2>
...
　
<h2 id="個数上限１複数ナップサック最適化">141. 個数上限１複数ナップサック最適化</h2>
...
　
<h2 id="複数ナップサック最適化">142. 複数ナップサック最適化</h2>
...
　
<h2 id="Convex Hull Trick">143. Convex Hull Trick</h2>
...
　
<h2 id="データを不変量別に分けて管理">146. データを不変量別に分けて管理</h2>
...
　
<h2 id="優先度付きキュー">152. 優先度付きキュー</h2>
...
　
<h2 id="最大・最小要素取得">157. 最大・最小要素取得</h2>
...
　
<h2 id="bitごとに計算">162. bitごとに計算</h2>
...
　
<h2 id="素数を法とする逆元のフェルマーの小定理による計算">164. 素数を法とする逆元のフェルマーの小定理による計算</h2>
...
　
<h2 id="冪等重みの最短経路長計算">169. 冪等重みの最短経路長計算</h2>
...
　
<h2 id="一次式の族の最大・最小値取得">171. 一次式の族の最大・最小値取得</h2>
...
　
<h2 id="タイリングを用いたミラー戦略">188. タイリングを用いたミラー戦略</h2>
...
　
<h2 id="辺を頂点とするグラフ">190. 辺を頂点とするグラフ</h2>
...
　
<h2 id="サイクルと非サイクルに分割">191. サイクルと非サイクルに分割</h2>
...
　
<h2 id="区間の重複度計算">218. 区間の重複度計算</h2>
...
　
<h2 id="グリッド上の価値最大化">220. グリッド上の価値最大化</h2>
...
　
<h2 id="コーシー・フロベニウスの補題">223. コーシー・フロベニウスの補題</h2>
...
　
<h2 id="最大公約数を用いた最小公倍数計算">225. 最大公約数を用いた最小公倍数計算</h2>
...
　
<h2 id="ユークリッドの互除法">228. ユークリッドの互除法</h2>
...
　
<h2 id="ユークリッドの互除法による最大公約数計算">229. ユークリッドの互除法による最大公約数計算</h2>
...
　
<h2 id="データ構造初期化">230. データ構造初期化</h2>
...
　
<h2 id="一対一対応と乱択の可換性">231. 一対一対応と乱択の可換性</h2>
...
　
<h2 id="bitset高速化">234. bitset高速化</h2>
...
　
<h2 id="内積の畳み込み計算">236. 内積の畳み込み計算</h2>
...
　
<h2 id="floor_sum">237. floor_sum</h2>
...
　
<h2 id="ベルトラン・チェビシェフの定理">238. ベルトラン・チェビシェフの定理</h2>
...
　
<h2 id="素数に注目する質問">239. 素数に注目する質問</h2>
...
　
<h2 id="対角線に言及する質問">240. 対角線に言及する質問</h2>
...
　
<h2 id="Covex Hull Trick">242. Covex Hull Trick</h2>
...
　
<h2 id="完全二部マッチング">247. 完全二部マッチング</h2>
...
　
<h2 id="単調関数の像計算">248. 単調関数の像計算</h2>
...
　
<h2 id="約数メビウス変換">254. 約数メビウス変換</h2>
...
　
<h2 id="指定序数の値の計算を各値未満の数え上げに帰着">255. 指定序数の値の計算を各値未満の数え上げに帰着</h2>
...
- 全体: ★3.1／diff <font color="yellowgreen">2196</font>
- 2024年: ★データなし／diffデータなし
- 2023年: ★3.1／diff <font color="yellowgreen">2196</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="DPのデータ構造高速化">258. DPのデータ構造高速化</h2>
...
　
<h2 id="最長共通接頭辞計算">262. 最長共通接頭辞計算</h2>
...
　
<h2 id="十分大きな法で計算">266. 十分大きな法で計算</h2>
...
　
<h2 id="剰余による確率的判定">269. 剰余による確率的判定</h2>
...
　
<h2 id="Moのアルゴリズム">270. Moのアルゴリズム</h2>
...
　
<h2 id="最小素因数前計算">271. 最小素因数前計算</h2>
...
　
<h2 id="inplace DP">274. inplace DP</h2>
...
　
<h2 id="冪乗との最大公約数の収束">276. 冪乗との最大公約数の収束</h2>
...
　
<h2 id="第二種スターリング数">277. 第二種スターリング数</h2>
...
　
<h2 id="像決め打ち二分探索">279. 像決め打ち二分探索</h2>
...
　
<h2 id="ローリングハッシュ">286. ローリングハッシュ</h2>
...
　
<h2 id="高速フーリエ変換">287. 高速フーリエ変換</h2>
...
　
<h2 id="区間を中間で分割してマージ">292. 区間を中間で分割してマージ</h2>
...
　
<h2 id="小さい法における二項係数">294. 小さい法における二項係数</h2>
...
　
<h2 id="小さい法に帰着させる再帰">295. 小さい法に帰着させる再帰</h2>
...
　
<h2 id="区間最大・最小値更新">296. 区間最大・最小値更新</h2>
...
　
<h2 id="分割統治畳み込み">297. 分割統治畳み込み</h2>
...
　
<h2 id="遅延セグメント木">299. 遅延セグメント木</h2>
...
　
<h2 id="区間二次形式取得">300. 区間二次形式取得</h2>
...
　
<h2 id="トポロジカルソート">305. トポロジカルソート</h2>
...
　
<h2 id="残余ネットワーク">307. 残余ネットワーク</h2>
...
　
<h2 id="アルゴリズム中に追加処理">311. アルゴリズム中に追加処理</h2>
