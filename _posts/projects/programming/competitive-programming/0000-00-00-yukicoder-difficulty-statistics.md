...
1. （★2.3／diff <font color="blue">1698</font>／17問）<a href="#ソート" class="tag">ソート</a>
...
1. （★2.5／diff <font color="blue">1801</font>／51問）<a href="#剰余計算" class="tag">剰余計算</a>
...
1. （★2.5／diff <font color="blue">1871</font>／18問）<a href="#繰り返し二乗法" class="tag">繰り返し二乗法</a>
...
1. （★2.6／diff <font color="blue">1913</font>／51問）<a href="#動的計画法" class="tag">動的計画法</a>／DP
...
　
<h2 id="木の頂点の次数計算">32. 木の頂点の次数計算</h2>
...
　
<h2 id="ナップサック最適化">33. ナップサック最適化</h2>
...
　
<h2 id="多項係数と組み合わせの関係">34. 多項係数と組み合わせの関係</h2>
...
　
<h2 id="負コストナップサック最適化">36. 負コストナップサック最適化</h2>
...
　
<h2 id="小数計算の整数への帰着">39. 小数計算の整数への帰着</h2>
...
　
<h2 id="重複選択個数の線形関係式">59. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#重複選択個数の線形関係式">重複選択個数の線形関係式</a></h2>
...
　
<h2 id="アルゴリズムのリアクティブ化">60. アルゴリズムのリアクティブ化</h2>
...
　
<h2 id="良いケースに帰着">63. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#良いケースに帰着">良いケースに帰着</a></h2>
...
　
<h2 id="等比数列の累積和計算">75. 等比数列の累積和計算</h2>
...
- 全体: ★2.3／diff <font color="blue">1698</font>
- 2024年: ★データなし／diffデータなし
- 2023年: ★2.2／diff <font color="deepskyblue">1570</font>
...
　
<h2 id="損をしない変形">85. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#損をしない変形">損をしない変形</a></h2>
...
　
<h2 id="合成による次元削減">88. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#合成による次元削減">合成による次元削減</a></h2>
...
　
<h2 id="操作回数上限以内の達成可能性判定を操作回数最小値計算に帰着">90. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#操作回数上限以内の達成可能性判定を操作回数最小値計算に帰着">操作回数上限以内の達成可能性判定を操作回数最小値計算に帰着</a></h2>
...
　
<h2 id="B進法表記を用いた構築">91. B進法表記を用いた構築</h2>
...
　
<h2 id="範囲加算更新を１つの配列に纏め上げ">93. 範囲加算更新を１つの配列に纏め上げ</h2>
...
　
<h2 id="指定序数の値の計算を被覆の先頭項管理で処理">100. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#指定序数の値の計算を被覆の先頭項管理で処理">指定序数の値の計算を被覆の先頭項管理で処理</a></h2>
...
　
<h2 id="言及する成分数を最大化する質問">101. 言及する成分数を最大化する質問</h2>
...
　
<h2 id="倍数メビウス変換">103. 倍数メビウス変換</h2>
...
　
<h2 id="不明な想定解">104. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#不明な想定解">不明な想定解</a></h2>
...
　
<h2 id="区間和の指定された区間計算">107. 区間和の指定された区間計算</h2>
...
　
<h2 id="表示可能性DP">109. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#表示可能性DP">表示可能性DP</a></h2>
...
　
<h2 id="ポテンシャル付き素集合データ構造">114. ポテンシャル付き素集合データ構造</h2>
...
　
<h2 id="始切片の数え上げを桁ごとの計算に帰着">115. 始切片の数え上げを桁ごとの計算に帰着</h2>
...
　
<h2 id="Vieta Jumping">117. Vieta Jumping</h2>
...
　
<h2 id="価値上限ありナップサック最適化">119. 価値上限ありナップサック最適化</h2>
...
　
<h2 id="重複選択可価値上限ありナップサック最適化">120. 重複選択可価値上限ありナップサック最適化</h2>
...
- 全体: ★2.5／diff <font color="blue">1801</font>
- 2024年: ★データなし／diffデータなし
- 2023年: ★2.4／diff <font color="blue">1657</font>
...
　
<h2 id="素数を法とする逆元の再帰計算">125. 素数を法とする逆元の再帰計算</h2>
...
　
<h2 id="不変量を保つ戦略">127. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#不変量を保つ戦略">不変量を保つ戦略</a></h2>
...
　
<h2 id="合成数を法とする逆元のオイラーの定理による計算">128. 合成数を法とする逆元のオイラーの定理による計算</h2>
...
　
<h2 id="繰り返し二乗法">131. 繰り返し二乗法</h2>

### 難易度統計

「繰り返し二乗法」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1871</font>
- 2024年: ★データなし／diffデータなし
- 2023年: ★2.5／diff <font color="blue">1894</font>
...
　
<h2 id="１次式の累積和計算">132. １次式の累積和計算</h2>
...
　
<h2 id="最終手番の任意性">135. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#最終手番の任意性">最終手番の任意性</a></h2>
...
　
<h2 id="場合分けによるmin・max計算">136. 場合分けによるmin・max計算</h2>
...
　
<h2 id="高さ奇数ニム和">138. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#高さ奇数ニム和">高さ奇数ニム和</a></h2>
...
　
<h2 id="オイラーグラフ判定">140. オイラーグラフ判定</h2>
...
　
<h2 id="上限・下限値に言及する質問">141. 上限・下限値に言及する質問</h2>
...
　
<h2 id="個数上限１複数ナップサック最適化">142. 個数上限１複数ナップサック最適化</h2>
...
　
<h2 id="複数ナップサック最適化">143. 複数ナップサック最適化</h2>
...
　
<h2 id="Convex Hull Trick">144. Convex Hull Trick</h2>
...
　
<h2 id="必勝戦略のリアクティブ化">146. 必勝戦略のリアクティブ化</h2>
...
　
<h2 id="データを不変量別に分けて管理">147. データを不変量別に分けて管理</h2>
...
- 全体: ★2.6／diff <font color="blue">1913</font>
- 2024年: ★データなし／diffデータなし
...
　
<h2 id="距離空間の重み付きグラフ化">151. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#距離空間の重み付きグラフ化">距離空間の重み付きグラフ化</a></h2>
...
　
<h2 id="押し付け戦略">160. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#押し付け戦略">押し付け戦略</a></h2>
...
　
<h2 id="ナップサック割り当て数え上げ">173. ナップサック割り当て数え上げ</h2>
...
　
<h2 id="一次式の族の最大・最小値取得">174. 一次式の族の最大・最小値取得</h2>
...
　
<h2 id="sorted set">181. sorted set</h2>
...
　
<h2 id="既存のアルゴリズムの変形">185. 既存のアルゴリズムの変形</h2>
...
　
<h2 id="緩和">187. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#緩和">緩和</a></h2>
...
　
<h2 id="２次元imos法">199. ２次元imos法</h2>
...
　
<h2 id="ポラードの$\rho$">202. ポラードの$\rho$</h2>
...
　
<h2 id="最近共通祖先計算">206. 最近共通祖先計算</h2>
...
　
<h2 id="弾性衝突を通過に翻訳して位置関係から復元">207. 弾性衝突を通過に翻訳して位置関係から復元</h2>
...
　
<h2 id="木の頂点の重さ計算">208. 木の頂点の重さ計算</h2>
...
　
<h2 id="区間の分割の数え上げを切片の分割に帰着">213. 区間の分割の数え上げを切片の分割に帰着</h2>
...
　
<h2 id="総和計算の期待値への帰着">214. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#総和計算の期待値への帰着">総和計算の期待値への帰着</a></h2>
...
　
<h2 id="グリッド上の価値最大化">221. グリッド上の価値最大化</h2>
...
　
<h2 id="解法場合分け">228. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#解法場合分け">解法場合分け</a></h2>
...
　
<h2 id="ベルトラン・チェビシェフの定理">239. ベルトラン・チェビシェフの定理</h2>
...
　
<h2 id="素数に注目する質問">240. 素数に注目する質問</h2>
...
　
<h2 id="対角線に言及する質問">241. 対角線に言及する質問</h2>
...
　
<h2 id="Covex Hull Trick">243. Covex Hull Trick</h2>
...
　
<h2 id="完全二部マッチング">249. 完全二部マッチング</h2>
...
　
<h2 id="単調関数の像計算">250. 単調関数の像計算</h2>
...
　
<h2 id="約数メビウス変換">256. 約数メビウス変換</h2>
...
　
<h2 id="タイリングを用いたミラー戦略">258. タイリングを用いたミラー戦略</h2>
...
　
<h2 id="辺を頂点とするグラフ">260. 辺を頂点とするグラフ</h2>
...
　
<h2 id="DPのデータ構造高速化">261. DPのデータ構造高速化</h2>
...
　
<h2 id="最長共通接頭辞計算">265. 最長共通接頭辞計算</h2>
...
　
<h2 id="指定序数の値の計算を各値未満の数え上げに帰着">269. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#指定序数の値の計算を各値未満の数え上げに帰着">指定序数の値の計算を各値未満の数え上げに帰着</a></h2>
...
　
<h2 id="十分大きな法で計算">270. 十分大きな法で計算</h2>
...
　
<h2 id="小さいケースの構築を拡張">272. 小さいケースの構築を拡張</h2>
...
　
<h2 id="剰余による確率的判定">273. 剰余による確率的判定</h2>
...
　
<h2 id="Moのアルゴリズム">274. Moのアルゴリズム</h2>
...
　
<h2 id="最小素因数前計算">275. 最小素因数前計算</h2>
...
　
<h2 id="inplace DP">278. inplace DP</h2>
...
　
<h2 id="冪乗との最大公約数の収束">280. 冪乗との最大公約数の収束</h2>
...
　
<h2 id="第二種スターリング数">281. 第二種スターリング数</h2>
...
　
<h2 id="高速フーリエ変換">290. 高速フーリエ変換</h2>
...
　
<h2 id="区間を中間で分割してマージ">295. 区間を中間で分割してマージ</h2>
...
　
<h2 id="小さい法における二項係数">297. 小さい法における二項係数</h2>
...
　
<h2 id="小さい法に帰着させる再帰">298. 小さい法に帰着させる再帰</h2>
...
　
<h2 id="区間最大・最小値更新">299. 区間最大・最小値更新</h2>
...
　
<h2 id="分割統治畳み込み">300. 分割統治畳み込み</h2>
...
　
<h2 id="遅延セグメント木">302. 遅延セグメント木</h2>
...
　
<h2 id="区間二次形式取得">303. 区間二次形式取得</h2>
...
　
<h2 id="トポロジカルソート">308. トポロジカルソート</h2>
...
　
<h2 id="残余ネットワーク">310. 残余ネットワーク</h2>
...
　
<h2 id="ハミルトン路構築">314. ハミルトン路構築</h2>
