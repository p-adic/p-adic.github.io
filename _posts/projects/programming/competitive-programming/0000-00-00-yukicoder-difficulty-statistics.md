...
通常問題の問題番号2056から2601までと2953以降を登録し終わりました。先は長いです。
...
1. （★1.2／diff <font color="brown">607</font>／35問）<a href="#実装" class="tag">実装</a>
...
1. （★1.3／diff <font color="green">868</font>／11問）<a href="#特殊な入出力" class="tag">特殊な入出力</a>
...
1. （★2／diff <font color="green">989</font>／4問）<a href="#set" class="tag">set</a>
...
1. （★2／diff <font color="deepskyblue">1329</font>／10問）<a href="#頻度表" class="tag">頻度表</a>
1. （★2／diff <font color="deepskyblue">1352</font>／1問）<a href="#負コストナップサック最適化" class="tag">負コストナップサック最適化</a>
1. （★2／diff <font color="deepskyblue">1443</font>／58問）<a href="#全探索" class="tag">全探索</a>
...
1. （★2.1／diff <font color="deepskyblue">1443</font>／21問）<a href="#貪欲法" class="tag">貪欲法</a>
1. （★2.1／diff <font color="deepskyblue">1474</font>／12問、[解説ページ](https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#操作を数値に翻訳)）<a href="#操作を数値に翻訳" class="tag">操作を数値に翻訳</a>
1. （★2.1／diff <font color="deepskyblue">1478</font>／43問）<a href="#場合分け" class="tag">場合分け</a>
...
1. （★2.2／diff <font color="blue">1697</font>／27問）<a href="#変数決め打ち" class="tag">変数決め打ち</a>
...
1. （★2.3／diff <font color="deepskyblue">1598</font>／14問）<a href="#累積和" class="tag">累積和</a>
...
1. （★2.3／diff <font color="blue">1794</font>／25問）<a href="#ソート" class="tag">ソート</a>
...
1. （★2.4／diff <font color="blue">1749</font>／66問）<a href="#剰余計算" class="tag">剰余計算</a>
1. （★2.4／diff <font color="blue">1846</font>／20問、[解説ページ](https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#損をしない変形)）<a href="#損をしない変形" class="tag">損をしない変形</a>
1. （★2.4／diff <font color="blue">1855</font>／8問）<a href="#最終手番に注目" class="tag">最終手番に注目</a>
1. （★2.4／diff <font color="blue">1867</font>／7問）<a href="#周期" class="tag">周期</a>
...
1. （★2.5／diff <font color="blue">1809</font>／55問）<a href="#分割統治法" class="tag">分割統治法</a>
...
1. （★2.5／diff <font color="blue">1900</font>／7問）<a href="#端から確定" class="tag">端から確定</a>
...
1. （★2.6／diff <font color="blue">1984</font>／15問）<a href="#集合管理" class="tag">集合管理</a>
...
1. （★2.7／diff <font color="blue">1993</font>／64問）<a href="#動的計画法" class="tag">動的計画法</a>／DP
...
1. （★2.9／diff <font color="yellowgreen">2078</font>／9問）<a href="#再帰" class="tag">再帰</a>
...
1. （★3／diff <font color="orange">2429</font>／1問）<a href="#剰余の定理" class="tag">剰余の定理</a>
...
1. （★3.5／diff <font color="red">2819</font>／2問）<a href="#多倍長整数" class="tag">多倍長整数</a>
...
1. （★4.2／diff <font color="red">3122</font>／2問）<a href="#掃き出し法" class="tag">掃き出し法</a>
...
1. （★5／diff <font color="darkgoldenrod ">3503</font>／1問）<a href="#階段化" class="tag">階段化</a>
...
　
<h2 id="等差数列の累積和計算">14. 等差数列の累積和計算</h2>
...
- 全体: ★2／diff <font color="green">989</font>
- 2024年: ★1／diff <font color="gray">352</font>
...
- 全体: ★2／diff <font color="deepskyblue">1329</font>
- 2024年: ★2／diff <font color="deepskyblue">1369</font>
...
- 全体: ★2／diff <font color="deepskyblue">1443</font>
- 2024年: ★2.5／diff <font color="blue">1709</font>
...
　
<h2 id="小数計算の整数への帰着">45. 小数計算の整数への帰着</h2>
...
　
<h2 id="剰余計算を桁の線形和に帰着">53. 剰余計算を桁の線形和に帰着</h2>
...
　
<h2 id="ナップサック最適化">54. ナップサック最適化</h2>
...
　
<h2 id="操作を数値に翻訳">58. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#操作を数値に翻訳">操作を数値に翻訳</a></h2>
...
- 全体: ★2.1／diff <font color="deepskyblue">1474</font>
- 2024年: ★データなし／diffデータなし
...
　
<h2 id="場合分け">59. 場合分け</h2>

### 難易度統計

「場合分け」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.1／diff <font color="deepskyblue">1478</font>
- 2024年: ★1.8／diff <font color="green">1167</font>
...
　
<h2 id="表示可能性DP">66. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#表示可能性DP">表示可能性DP</a></h2>
...
　
<h2 id="素因数分解による約数の生成式">67. 素因数分解による約数の生成式</h2>
...
　
<h2 id="変数決め打ち">72. 変数決め打ち</h2>

### 難易度統計

「変数決め打ち」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.2／diff <font color="blue">1697</font>
- 2024年: ★2.5／diff <font color="blue">1709</font>
...
　
<h2 id="マッチ度ごとに管理">80. マッチ度ごとに管理</h2>
...
- 全体: ★2.3／diff <font color="deepskyblue">1598</font>
...
- 全体: ★2.3／diff <font color="blue">1794</font>
- 2024年: ★3／diff <font color="orange">2585</font>
...
　
<h2 id="アルゴリズムのリアクティブ化">93. アルゴリズムのリアクティブ化</h2>
...
　
<h2 id="階乗による二項係数の明示式">94. 階乗による二項係数の明示式</h2>
...
- 全体: ★2.4／diff <font color="blue">1749</font>
- 2024年: ★1.5／diff <font color="brown">686</font>
...
　
<h2 id="損をしない変形">99. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#損をしない変形">損をしない変形</a></h2>
...
- 全体: ★2.4／diff <font color="blue">1846</font>
- 2024年: ★3／diff <font color="orange">2585</font>
...
- 全体: ★2.4／diff <font color="blue">1867</font>
- 2024年: ★データなし／diffデータなし
- 2023年: ★2.4／diff <font color="blue">1813</font>
- 2022年: ★2.5／diff <font color="yellowgreen">2191</font>
...
　
<h2 id="符号全探索による絶対値計算">114. 符号全探索による絶対値計算</h2>
...
　
<h2 id="指定序数の値の計算を被覆の先頭項管理で処理">115. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#指定序数の値の計算を被覆の先頭項管理で処理">指定序数の値の計算を被覆の先頭項管理で処理</a></h2>
...
　
<h2 id="言及する成分数を最大化する質問">116. 言及する成分数を最大化する質問</h2>
...
　
<h2 id="倍数メビウス変換">117. 倍数メビウス変換</h2>
...
　
<h2 id="不明な想定解">118. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#不明な想定解">不明な想定解</a></h2>
...
　
<h2 id="ポテンシャル付き素集合データ構造">125. ポテンシャル付き素集合データ構造</h2>
...
　
<h2 id="Vieta Jumping">131. Vieta Jumping</h2>
...
　
<h2 id="価値上限ありナップサック最適化">133. 価値上限ありナップサック最適化</h2>
...
　
<h2 id="重複選択可価値上限ありナップサック最適化">134. 重複選択可価値上限ありナップサック最適化</h2>
...
　
<h2 id="分割統治法">137. 分割統治法</h2>

### 難易度統計

「分割統治法」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1809</font>
- 2024年: ★3／diff <font color="orange">2585</font>
- 2023年: ★2.5／diff <font color="blue">1724</font>
...
　
<h2 id="不変量を保つ戦略">138. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#不変量を保つ戦略">不変量を保つ戦略</a></h2>
...
　
<h2 id="オイラーの定理による逆元の明示式">141. オイラーの定理による逆元の明示式</h2>
...
　
<h2 id="合成数を法とする逆元計算">142. 合成数を法とする逆元計算</h2>
...
　
<h2 id="素数列による試し割り法">145. 素数列による試し割り法</h2>
...
　
<h2 id="指定序数の値の計算を始切片の数え上げに帰着">146. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#指定序数の値の計算を始切片の数え上げに帰着">指定序数の値の計算を始切片の数え上げに帰着</a></h2>
...
　
<h2 id="１次式の累積和計算">148. １次式の累積和計算</h2>
...
　
<h2 id="区間を切片の差に翻訳">149. 区間を切片の差に翻訳</h2>
...
- 2024年: ★データなし／diffデータなし
- 2023年: ★2.5／diff <font color="blue">1882</font>
...
　
<h2 id="最終手番の任意性">151. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#最終手番の任意性">最終手番の任意性</a></h2>
...
　
<h2 id="場合分けによるmin・max計算">152. 場合分けによるmin・max計算</h2>
...
　
<h2 id="minimax法">154. minimax法</h2>
...
　
<h2 id="高さ奇数ニム和">155. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#高さ奇数ニム和">高さ奇数ニム和</a></h2>
...
　
<h2 id="個数上限１複数ナップサック最適化">162. 個数上限１複数ナップサック最適化</h2>
...
　
<h2 id="複数ナップサック最適化">163. 複数ナップサック最適化</h2>
...
　
<h2 id="必勝戦略のリアクティブ化">165. 必勝戦略のリアクティブ化</h2>
...
　
<h2 id="全順序集合を状態に持つゲームをP状態とN状態の区間に分割">166. 全順序集合を状態に持つゲームをP状態とN状態の区間に分割</h2>
...
　
<h2 id="終点からの経路計算">169. 終点からの経路計算</h2>
...
　
<h2 id="素数を法とする逆元計算">172. 素数を法とする逆元計算</h2>
...
　
<h2 id="ナップサック割り当て数え上げ">182. ナップサック割り当て数え上げ</h2>
...
　
<h2 id="配列を像・頻度表で管理">186. 配列を像・頻度表で管理</h2>
...
　
<h2 id="bitごとに計算">192. bitごとに計算</h2>
...
　
<h2 id="区間和の指定された区間数え上げ">195. 区間和の指定された区間数え上げ</h2>
...
　
<h2 id="エラトステネスの篩">196. エラトステネスの篩</h2>
...
　
<h2 id="冪等重みの最短経路長計算">200. 冪等重みの最短経路長計算</h2>
...
　
<h2 id="優先度付きキュー">202. 優先度付きキュー</h2>
...
　
<h2 id="Convex Hull Trick">204. Convex Hull Trick</h2>
...
　
<h2 id="一次式の族の最大・最小値取得">205. 一次式の族の最大・最小値取得</h2>
...
　
<h2 id="データを不変量別に分割して管理">207. データを不変量別に分割して管理</h2>
...
　
<h2 id="押し付け戦略">213. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#押し付け戦略">押し付け戦略</a></h2>
...
　
<h2 id="既存のアルゴリズムの変形">217. 既存のアルゴリズムの変形</h2>
...
- 全体: ★2.9／diff <font color="yellowgreen">2078</font>
- 2024年: ★データなし／diffデータなし
...
　
<h2 id="約数の走査を倍数の走査に帰着">222. 約数の走査を倍数の走査に帰着</h2>
...
　
<h2 id="閉路と残りに分割">224. 閉路と残りに分割</h2>
...
　
<h2 id="inplace DP">231. inplace DP</h2>
...
　
<h2 id="区間スケジューリング">232. 区間スケジューリング</h2>
...
　
<h2 id="最近共通祖先計算">238. 最近共通祖先計算</h2>
...
　
<h2 id="弾性衝突を通過に翻訳して位置関係から復元">239. 弾性衝突を通過に翻訳して位置関係から復元</h2>
...
　
<h2 id="木の頂点の重さ計算">240. 木の頂点の重さ計算</h2>
...
　
<h2 id="区間最大・最小値取得">241. 区間最大・最小値取得</h2>
...
　
<h2 id="始点と終点からの経路計算">243. 始点と終点からの経路計算</h2>
...
　
<h2 id="区間の分割の数え上げを切片の分割に帰着">245. 区間の分割の数え上げを切片の分割に帰着</h2>
...
　
<h2 id="総和計算の期待値への帰着">247. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#総和計算の期待値への帰着">総和計算の期待値への帰着</a></h2>
...
　
<h2 id="最適遷移の写像化">248. 最適遷移の写像化</h2>
...
　
<h2 id="２次元imos法">249. ２次元imos法</h2>
...
　
<h2 id="ローリングハッシュ">282. ローリングハッシュ</h2>
...
　
<h2 id="単調関数の像計算を階差の非零点の数え上げに帰着">283. 単調関数の像計算を階差の非零点の数え上げに帰着</h2>
...
　
<h2 id="タイリングによるミラー戦略">290. タイリングによるミラー戦略</h2>
...
　
<h2 id="区間の部分列の数え上げをモノイド演算に翻訳">291. 区間の部分列の数え上げをモノイド演算に翻訳</h2>
...
　
<h2 id="辺を頂点とするグラフに翻訳">292. 辺を頂点とするグラフに翻訳</h2>
...
　
<h2 id="始切片の数え上げを桁ごとの計算に帰着">294. 始切片の数え上げを桁ごとの計算に帰着</h2>
...
　
<h2 id="DPのデータ構造高速化">297. DPのデータ構造高速化</h2>
...
　
<h2 id="十分大きな法で計算">309. 十分大きな法で計算</h2>
...
　
<h2 id="剰余による確率的判定">310. 剰余による確率的判定</h2>
...
　
<h2 id="約数メビウス変換">311. 約数メビウス変換</h2>
...
　
<h2 id="シュトルツ・チェザロの定理">314. シュトルツ・チェザロの定理</h2>
...
　
<h2 id="移動回数の期待値を距離で割った値の極限計算を平均移動速度に帰着">315. 移動回数の期待値を距離で割った値の極限計算を平均移動速度に帰着</h2>
...
　
<h2 id="整礎な操作の試行回数の期待値を各状態への到達確率の和に帰着">316. 整礎な操作の試行回数の期待値を各状態への到達確率の和に帰着</h2>
...
　
<h2 id="Moのアルゴリズム">317. Moのアルゴリズム</h2>
...
　
<h2 id="メビウスの反転公式">327. メビウスの反転公式</h2>
...
　
<h2 id="冪乗との最大公約数の収束">328. 冪乗との最大公約数の収束</h2>
...
　
<h2 id="第二種スターリング数">329. 第二種スターリング数</h2>
...
　
<h2 id="区間を中間で分割してマージ">332. 区間を中間で分割してマージ</h2>
...
　
<h2 id="多倍長整数">337. 多倍長整数</h2>

### 難易度統計

「多倍長整数」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3.5／diff <font color="red">2819</font>
- 2024年: ★データなし／diffデータなし
...
　
<h2 id="タイリング可能性を領域の細分による不変量計算に帰着">338. タイリング可能性を領域の細分による不変量計算に帰着</h2>
...
　
<h2 id="cyclic orderつき全方位木DP">340. cyclic orderつき全方位木DP</h2>
...
　
<h2 id="小さい法に帰着させる再帰">347. 小さい法に帰着させる再帰</h2>
...
　
<h2 id="区間最大・最小値更新">349. 区間最大・最小値更新</h2>
...
　
<h2 id="高速フーリエ変換">352. 高速フーリエ変換</h2>
...
　
<h2 id="掃き出し法">354. 掃き出し法</h2>

### 難易度統計

「掃き出し法」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★4.2／diff <font color="red">3122</font>
- 2024年: ★データなし／diffデータなし
...
　
<h2 id="遅延セグメント木">355. 遅延セグメント木</h2>
...
　
<h2 id="データ構造をマージする一般的なテク">356. データ構造をマージする一般的なテク</h2>
...
　
<h2 id="演算の反復の分割統治">357. 演算の反復の分割統治</h2>
...
　
<h2 id="Polynomial Taylor shift">358. Polynomial Taylor shift</h2>
...
　
<h2 id="ファウルハーバーの公式">359. ファウルハーバーの公式</h2>
...
　
<h2 id="parallel tree contraction">360. parallel tree contraction</h2>
...
　
<h2 id="演算の適用を１次式の合成に翻訳">361. 演算の適用を１次式の合成に翻訳</h2>
...
　
<h2 id="区間二次形式取得">364. 区間二次形式取得</h2>
...
　
<h2 id="Lindstrom-Gessel-Viennotの補題">367. Lindstrom-Gessel-Viennotの補題</h2>
...
　
<h2 id="ファンデルモンドの行列式計算">368. ファンデルモンドの行列式計算</h2>
...
　
<h2 id="半標準ヤングタブロー">370. 半標準ヤングタブロー</h2>
...
　
<h2 id="半標準ヤングタブローとGelfand-Tsetlinパターンの対応">371. 半標準ヤングタブローとGelfand-Tsetlinパターンの対応</h2>
...
　
<h2 id="半標準ヤングタブローと非交差経路の対応">372. 半標準ヤングタブローと非交差経路の対応</h2>
...
　
<h2 id="標準ヤングタブロー">375. 標準ヤングタブロー</h2>
...
　
<h2 id="Bostan-Mori法">377. Bostan-Mori法</h2>
...
　
<h2 id="多項式のユークリッドの互除法">379. 多項式のユークリッドの互除法</h2>
...
　
<h2 id="多項式を法とする逆元計算">380. 多項式を法とする逆元計算</h2>
...
　
<h2 id="Polynomial Taylor Shift">382. Polynomial Taylor Shift</h2>
...
　
<h2 id="一次分数変換と対数関数による変数変換の合成">384. 一次分数変換と対数関数による変数変換の合成</h2>
...
　
<h2 id="指数関数による変数変換と一次分数変換の合成">385. 指数関数による変数変換と一次分数変換の合成</h2>
...
　
<h2 id="微分作用素を変数変換で簡易化">386. 微分作用素を変数変換で簡易化</h2>
...
　
<h2 id="トポロジカルソート">388. トポロジカルソート</h2>
...
　
<h2 id="残余ネットワーク">390. 残余ネットワーク</h2>
...
　
<h2 id="階段化">391. 階段化</h2>

### 難易度統計

「階段化」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
...
　
<h2 id="指定序数の値の計算を桁ごとの計算に帰着">392. 指定序数の値の計算を桁ごとの計算に帰着</h2>
...
　
<h2 id="非負整数をB進法でベクトルに翻訳">393. 非負整数をB進法でベクトルに翻訳</h2>
...
　
<h2 id="ハミルトン路構築">396. ハミルトン路構築</h2>
