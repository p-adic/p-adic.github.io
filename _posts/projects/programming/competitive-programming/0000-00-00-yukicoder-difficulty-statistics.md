...
通常問題の問題番号2056以降のupsolve済み問題（現在進行系のコンテストは除く）を登録し終わりました。次は数学的知識問題と教育的問題に取り掛かります。
...
1. （★1.1／diff <font color="brown">770</font>／5問）<a href="#カレンダー計算" class="tag">カレンダー計算</a>
1. （★1.2／diff <font color="brown">646</font>／2問）<a href="#切り上げ" class="tag">切り上げ</a>
1. （★1.2／diff <font color="brown">712</font>／73問）<a href="#実装" class="tag">実装</a>
1. （★1.2／diff <font color="green">830</font>／2問）<a href="#貨幣計算" class="tag">貨幣計算</a>
1. （★1.2／diff <font color="green">1002</font>／2問）<a href="#積のオーバーフロー回避" class="tag">積のオーバーフロー回避</a>
1. （★1.2／diff <font color="deepskyblue">1523</font>／2問）<a href="#getline" class="tag">getline</a>
1. （★1.3／diff <font color="brown">798</font>／3問）<a href="#符号なし64bit整数" class="tag">符号なし64bit整数</a>
1. （★1.3／diff <font color="green">911</font>／24問）<a href="#64bit整数" class="tag">64bit整数</a>
...
1. （★1.5／diff <font color="green">919</font>／1問）<a href="#選択順依存価値ナップサック最適化" class="tag">選択順依存価値ナップサック最適化</a>
...
1. （★1.5／diff <font color="green">1103</font>／2問）<a href="#符号なし64bit整数によるオーバーフロー回避" class="tag">符号なし64bit整数によるオーバーフロー回避</a>
...
1. （★1.8／diff <font color="deepskyblue">1412</font>／4問）<a href="#オーバーフロー回避" class="tag">オーバーフロー回避</a>
...
1. （★1.9／diff <font color="deepskyblue">1392</font>／8問）<a href="#指定序数の値の計算や指定要素以下・未満の要素数え上げや一次元最近点計算をソートに帰着" class="tag">指定序数の値の計算や指定要素以下・未満の要素数え上げや一次元最近点計算をソートに帰着</a>
1. （★2／diff <font color="green">849</font>／1問）<a href="#極小互換表示" class="tag">極小互換表示</a>
...
1. （★2／diff <font color="deepskyblue">1390</font>／72問）<a href="#場合分け" class="tag">場合分け</a>
1. （★2／diff <font color="deepskyblue">1396</font>／2問）<a href="#一次方程式・不等式の求解" class="tag">一次方程式・不等式の求解</a>
1. （★2／diff <font color="deepskyblue">1442</font>／3問）<a href="#順列のリアクティブによる特定" class="tag">順列のリアクティブによる特定</a>
1. （★2／diff <font color="deepskyblue">1446</font>／94問）<a href="#全探索" class="tag">全探索</a>
...
1. （★2／diff <font color="deepskyblue">1488</font>／1問）<a href="#平方数列の累積和計算" class="tag">平方数列の累積和計算</a>
...
1. （★2／diff <font color="deepskyblue">1509</font>／4問）<a href="#外積計算" class="tag">外積計算</a>
1. （★2／diff <font color="deepskyblue">1548</font>／1問）<a href="#文字列のリアクティブによる特定" class="tag">文字列のリアクティブによる特定</a>
...
1. （★2／diff <font color="deepskyblue">1596</font>／1問）<a href="#bool値のリアクティブによる特定" class="tag">bool値のリアクティブによる特定</a>
...
1. （★2／diff <font color="blue">1695</font>／2問）<a href="#区間要素数取得を指定要素以下・未満の要素数え上げに帰着" class="tag">区間要素数取得を指定要素以下・未満の要素数え上げに帰着</a>
...
1. （★2.1／diff <font color="deepskyblue">1332</font>／3問）<a href="#二分法" class="tag">二分法</a>
1. （★2.1／diff <font color="deepskyblue">1340</font>／16問）<a href="#ギャグ" class="tag">ギャグ</a>
1. （★2.1／diff <font color="deepskyblue">1430</font>／4問）<a href="#多次元コストナップサック最適化" class="tag">多次元コストナップサック最適化</a>
1. （★2.1／diff <font color="deepskyblue">1521</font>／10問）<a href="#等差数列の累積和計算" class="tag">等差数列の累積和計算</a>
1. （★2.1／diff <font color="deepskyblue">1529</font>／11問）<a href="#小数型" class="tag">小数型</a>
...
1. （★2.1／diff <font color="blue">1631</font>／5問）<a href="#連長圧縮" class="tag">連長圧縮</a>／ランレングス圧縮／RLE
...
1. （★2.2／diff <font color="deepskyblue">1312</font>／5問）<a href="#巡回置換表示" class="tag">巡回置換表示</a>
...
1. （★2.2／diff <font color="deepskyblue">1450</font>／19問）<a href="#連結成分取得" class="tag">連結成分取得</a>
...
1. （★2.2／diff <font color="deepskyblue">1498</font>／15問）<a href="#約数列挙" class="tag">約数列挙</a>
...
1. （★2.2／diff <font color="deepskyblue">1545</font>／27問）<a href="#幅優先探索" class="tag">幅優先探索</a>／BFS
...
1. （★2.2／diff <font color="blue">1607</font>／2問）<a href="#多項係数計算" class="tag">多項係数計算</a>
...
1. （★2.3／diff <font color="deepskyblue">1414</font>／3問）<a href="#ルジャンドルの公式" class="tag">ルジャンドルの公式</a>
...
1. （★2.3／diff <font color="deepskyblue">1515</font>／20問）<a href="#素集合データ構造" class="tag">素集合データ構造</a>／Union Find／UF／Disjoint Set Union／DSU
1. （★2.3／diff <font color="deepskyblue">1565</font>／13問）<a href="#余事象に注目" class="tag">余事象に注目</a>
...
1. （★2.3／diff <font color="blue">1633</font>／17問）<a href="#試し割り法" class="tag">試し割り法</a>
1. （★2.3／diff <font color="blue">1665</font>／17問）<a href="#位取り記法表示" class="tag">位取り記法表示</a>
1. （★2.3／diff <font color="blue">1687</font>／4問）<a href="#ヘルド・カープ法" class="tag">ヘルド・カープ法</a>／Held-Karp法
...
1. （★2.3／diff <font color="blue">1758</font>／9問）<a href="#動的mod" class="tag">動的mod</a>
1. （★2.3／diff <font color="blue">1780</font>／13問）<a href="#最終手番に注目" class="tag">最終手番に注目</a>
1. （★2.3／diff <font color="blue">1782</font>／44問）<a href="#変数決め打ち" class="tag">変数決め打ち</a>
...
1. （★2.4／diff <font color="deepskyblue">1437</font>／5問）<a href="#門松列DP" class="tag">門松列DP</a>
1. （★2.4／diff <font color="deepskyblue">1584</font>／5問）<a href="#配列の構築" class="tag">配列の構築</a>
1. （★2.4／diff <font color="blue">1611</font>／8問）<a href="#ド・モルガンの法則" class="tag">ド・モルガンの法則</a>
...
1. （★2.4／diff <font color="blue">1692</font>／14問）<a href="#01列と非負整数の対応" class="tag">01列と非負整数の対応</a>
1. （★2.4／diff <font color="blue">1725</font>／17問）<a href="#尺取り法" class="tag">尺取り法</a>
1. （★2.4／diff <font color="blue">1740</font>／42問）<a href="#累積積による冪乗・階乗計算" class="tag">累積積による冪乗・階乗計算</a>
1. （★2.4／diff <font color="blue">1748</font>／39問）<a href="#集合管理" class="tag">集合管理</a>
...
1. （★2.4／diff <font color="blue">1765</font>／31問）<a href="#不変量に注目" class="tag">不変量に注目</a>
1. （★2.4／diff <font color="blue">1769</font>／31問）<a href="#累積和" class="tag">累積和</a>
...
1. （★2.5／diff <font color="deepskyblue">1550</font>／1問）<a href="#極小基本互換表示" class="tag">極小基本互換表示</a>
1. （★2.5／diff <font color="deepskyblue">1550</font>／1問）<a href="#置換の符号計算" class="tag">置換の符号計算</a>
...
1. （★2.5／diff <font color="blue">1671</font>／10問）<a href="#配列を像・頻度表で管理" class="tag">配列を像・頻度表で管理</a>
1. （★2.5／diff <font color="blue">1678</font>／13問）<a href="#マッチ度ごとに管理" class="tag">マッチ度ごとに管理</a>
...
1. （★2.5／diff <font color="blue">1715</font>／6問）<a href="#指定序数の値の計算を指定要素以下・未満の要素数え上げに帰着" class="tag">指定序数の値の計算を指定要素以下・未満の要素数え上げに帰着</a>
...
1. （★2.5／diff <font color="blue">1749</font>／1問）<a href="#ベルマン・フォード法" class="tag">ベルマン・フォード法</a>／Bellman-Ford法
1. （★2.5／diff <font color="blue">1749</font>／1問）<a href="#負閉路検出" class="tag">負閉路検出</a>
1. （★2.5／diff <font color="blue">1752</font>／1問）<a href="#一要素重複挿入更新" class="tag">一要素重複挿入更新</a>
1. （★2.5／diff <font color="blue">1753</font>／2問）<a href="#部分集合DP" class="tag">部分集合DP</a>
1. （★2.5／diff <font color="blue">1754</font>／29問）<a href="#素因数分解" class="tag">素因数分解</a>
1. （★2.5／diff <font color="blue">1754</font>／2問）<a href="#差分管理" class="tag">差分管理</a>
1. （★2.5／diff <font color="blue">1756</font>／16問）<a href="#深さ優先探索" class="tag">深さ優先探索</a>／DFS
1. （★2.5／diff <font color="blue">1765</font>／11問）<a href="#一要素削除更新" class="tag">一要素削除更新</a>
1. （★2.5／diff <font color="blue">1766</font>／13問）<a href="#01列と部分集合の対応" class="tag">01列と部分集合の対応</a>
...
1. （★2.5／diff <font color="blue">1782</font>／13問）<a href="#操作・遷移の纏め上げ" class="tag">操作・遷移の纏め上げ</a>
1. （★2.5／diff <font color="blue">1794</font>／11問）<a href="#bitごとに計算" class="tag">bitごとに計算</a>
...
1. （★2.5／diff <font color="blue">1813</font>／25問）<a href="#階乗計算" class="tag">階乗計算</a>
1. （★2.5／diff <font color="blue">1825</font>／13問）<a href="#最大公約数計算" class="tag">最大公約数計算</a>／GCD計算
1. （★2.5／diff <font color="blue">1827</font>／2問）<a href="#mex取得" class="tag">mex取得</a>
1. （★2.5／diff <font color="blue">1831</font>／48問）<a href="#二分探索" class="tag">二分探索</a>
1. （★2.5／diff <font color="blue">1831</font>／81問）<a href="#分割統治法（広義：decrease-and-conquer）" class="tag">分割統治法（広義：decrease-and-conquer）</a>
...
1. （★2.5／diff <font color="blue">1838</font>／123問）<a href="#modint型" class="tag">modint型</a>
...
1. （★2.5／diff <font color="blue">1859</font>／2問）<a href="#next DP" class="tag">next DP</a>
1. （★2.5／diff <font color="blue">1859</font>／1問）<a href="#置換の位数計算" class="tag">置換の位数計算</a>
1. （★2.5／diff <font color="blue">1859</font>／1問）<a href="#排他的被覆数え上げ" class="tag">排他的被覆数え上げ</a>
1. （★2.5／diff <font color="blue">1864</font>／4問）<a href="#円環の倍化実装" class="tag">円環の倍化実装</a>
1. （★2.5／diff <font color="blue">1867</font>／61問）<a href="#冪乗計算" class="tag">冪乗計算</a>
1. （★2.5／diff <font color="blue">1868</font>／24問）<a href="#最短経路長計算" class="tag">最短経路長計算</a>
1. （★2.5／diff <font color="blue">1869</font>／13問）<a href="#最大・最小要素取得" class="tag">最大・最小要素取得</a>
1. （★2.5／diff <font color="blue">1874</font>／7問、[解説ページ](https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#距離空間の重み付きグラフ化)）<a href="#距離空間の重み付きグラフ化" class="tag">距離空間の重み付きグラフ化</a>
...
1. （★2.5／diff <font color="blue">1900</font>／1問）<a href="#選択回数依存コスト重複選択可ナップサック最適化" class="tag">選択回数依存コスト重複選択可ナップサック最適化</a>
1. （★2.5／diff <font color="blue">1923</font>／6問）<a href="#bitDP" class="tag">bitDP</a>
...
1. （★2.5／diff <font color="yellowgreen">2011</font>／2問）<a href="#ワーシャル・フロイド法" class="tag">ワーシャル・フロイド法</a>／Floyd-Warshall法／Warshall-Floyd法
...
1. （★2.5／diff <font color="yellowgreen">2144</font>／4問）<a href="#整数のリアクティブによる特定" class="tag">整数のリアクティブによる特定</a>
...
1. （★2.5／diff <font color="yellowgreen">2306</font>／1問）<a href="#線分の交差判定" class="tag">線分の交差判定</a>
...
1. （★2.5／diff <font color="orange">2503</font>／1問）<a href="#必勝戦略のリアクティブによる特定" class="tag">必勝戦略のリアクティブによる特定</a>
...
1. （★2.6／diff <font color="blue">1802</font>／15問）<a href="#付値計算" class="tag">付値計算</a>
1. （★2.6／diff <font color="blue">1810</font>／17問）<a href="#階乗による二項係数・多項係数計算" class="tag">階乗による二項係数・多項係数計算</a>
1. （★2.6／diff <font color="blue">1816</font>／23問）<a href="#差分計算" class="tag">差分計算</a>
...
1. （★2.6／diff <font color="blue">1826</font>／21問）<a href="#階乗逆元計算" class="tag">階乗逆元計算</a>
...
1. （★2.6／diff <font color="blue">1845</font>／4問）<a href="#転倒数計算" class="tag">転倒数計算</a>
1. （★2.6／diff <font color="blue">1849</font>／6問）<a href="#枝刈り" class="tag">枝刈り</a>
1. （★2.6／diff <font color="blue">1853</font>／26問）<a href="#同じ値の纏め上げ" class="tag">同じ値の纏め上げ</a>
1. （★2.6／diff <font color="blue">1864</font>／3問）<a href="#二項定理" class="tag">二項定理</a>
1. （★2.6／diff <font color="blue">1867</font>／8問）<a href="#集合の変化イベント走査による差分計算" class="tag">集合の変化イベント走査による差分計算</a>
1. （★2.6／diff <font color="blue">1881</font>／5問）<a href="#ナップサック分割統治" class="tag">ナップサック分割統治</a>
1. （★2.6／diff <font color="blue">1894</font>／10問）<a href="#素因数分解による付値計算" class="tag">素因数分解による付値計算</a>
1. （★2.6／diff <font color="blue">1914</font>／37問）<a href="#逆元の再帰計算" class="tag">逆元の再帰計算</a>
1. （★2.6／diff <font color="blue">1916</font>／48問）<a href="#素数を法とする逆元計算" class="tag">素数を法とする逆元計算</a>
1. （★2.6／diff <font color="blue">1921</font>／11問）<a href="#フェルマーの小定理による逆元計算" class="tag">フェルマーの小定理による逆元計算</a>
1. （★2.6／diff <font color="blue">1942</font>／112問）<a href="#動的計画法" class="tag">動的計画法</a>／DP
1. （★2.6／diff <font color="blue">1942</font>／44問）<a href="#繰り返し二乗法" class="tag">繰り返し二乗法</a>
1. （★2.6／diff <font color="blue">1945</font>／9問）<a href="#包除原理" class="tag">包除原理</a>
1. （★2.6／diff <font color="blue">1948</font>／5問）<a href="#倍数走査による約数列挙前計算" class="tag">倍数走査による約数列挙前計算</a>
1. （★2.6／diff <font color="blue">1948</font>／5問）<a href="#約数走査を倍数走査に帰着" class="tag">約数走査を倍数走査に帰着</a>
...
1. （★2.6／diff <font color="blue">1998</font>／28問）<a href="#端から確定" class="tag">端から確定</a>
1. （★2.6／diff <font color="yellowgreen">2003</font>／3問）<a href="#探索・求解アルゴリズムによる構築" class="tag">探索・求解アルゴリズムによる構築</a>
1. （★2.6／diff <font color="yellowgreen">2004</font>／3問）<a href="#剰余の被除数を止めた総和計算" class="tag">剰余の被除数を止めた総和計算</a>
...
1. （★2.7／diff <font color="blue">1874</font>／17問、[解説ページ](https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#01列に翻訳)）<a href="#01列に翻訳" class="tag">01列に翻訳</a>
...
1. （★2.7／diff <font color="blue">1898</font>／37問）<a href="#区間和取得" class="tag">区間和取得</a>
...
1. （★2.7／diff <font color="blue">1916</font>／15問）<a href="#ユークリッドの互除法" class="tag">ユークリッドの互除法</a>
...
1. （★2.7／diff <font color="blue">1936</font>／20問）<a href="#二項係数計算" class="tag">二項係数計算</a>／場合の数計算
...
1. （★2.7／diff <font color="blue">1993</font>／12問）<a href="#区間要素数取得" class="tag">区間要素数取得</a>
1. （★2.7／diff <font color="blue">1994</font>／21問）<a href="#数え上げを総和計算に帰着" class="tag">数え上げを総和計算に帰着</a>
1. （★2.7／diff <font color="blue">1995</font>／4問）<a href="#区間代入更新" class="tag">区間代入更新</a>
...
1. （★2.7／diff <font color="yellowgreen">2014</font>／14問、[解説ページ](https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#緩和)）<a href="#緩和" class="tag">緩和</a>
1. （★2.7／diff <font color="yellowgreen">2020</font>／5問）<a href="#単調列数え上げ" class="tag">単調列数え上げ</a>
1. （★2.7／diff <font color="yellowgreen">2027</font>／2問）<a href="#商のfloorの分子を止めた総和計算" class="tag">商のfloorの分子を止めた総和計算</a>
1. （★2.7／diff <font color="yellowgreen">2078</font>／2問）<a href="#描画可能性を実際に描画して判定" class="tag">描画可能性を実際に描画して判定</a>
1. （★2.7／diff <font color="yellowgreen">2099</font>／9問）<a href="#無向木の有向化" class="tag">無向木の有向化</a>
1. （★2.7／diff <font color="yellowgreen">2106</font>／9問）<a href="#木DP" class="tag">木DP</a>
...
1. （★2.8／diff <font color="blue">1841</font>／3問）<a href="#上界制約を無視した数え上げを桁ごとに前計算" class="tag">上界制約を無視した数え上げを桁ごとに前計算</a>
1. （★2.8／diff <font color="blue">1866</font>／7問）<a href="#イベントソート" class="tag">イベントソート</a>
1. （★2.8／diff <font color="blue">1912</font>／8問）<a href="#指定要素以下・未満の要素数え上げを桁ごとの計算に帰着" class="tag">指定要素以下・未満の要素数え上げを桁ごとの計算に帰着</a>
1. （★2.8／diff <font color="blue">1922</font>／6問）<a href="#sorted set" class="tag">sorted set</a>
1. （★2.8／diff <font color="blue">1926</font>／4問）<a href="#ループ戦略" class="tag">ループ戦略</a>
...
1. （★2.8／diff <font color="yellowgreen">2004</font>／14問）<a href="#平面走査" class="tag">平面走査</a>
1. （★2.8／diff <font color="yellowgreen">2014</font>／22問）<a href="#フェニック木" class="tag">フェニック木</a>／BIT
...
1. （★2.8／diff <font color="yellowgreen">2066</font>／3問）<a href="#商のfloorの分母を止めた総和計算" class="tag">商のfloorの分母を止めた総和計算</a>
...
1. （★2.8／diff <font color="yellowgreen">2112</font>／19問）<a href="#多重総和・総乗計算" class="tag">多重総和・総乗計算</a>
...
1. （★2.8／diff <font color="yellowgreen">2141</font>／9問）<a href="#調和数列による計算量評価" class="tag">調和数列による計算量評価</a>
1. （★2.8／diff <font color="yellowgreen">2225</font>／9問）<a href="#ナップサック割り当て数え上げ" class="tag">ナップサック割り当て数え上げ</a>
...
1. （★2.8／diff <font color="yellowgreen">2378</font>／4問）<a href="#累積max・min" class="tag">累積max・min</a>
...
1. （★2.9／diff <font color="yellowgreen">2103</font>／10問、[解説ページ](https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#解法場合分け)）<a href="#解法場合分け" class="tag">解法場合分け</a>
...
1. （★3／diff <font color="blue">1959</font>／1問）<a href="#選択組み合わせ報酬付きナップサック最適化" class="tag">選択組み合わせ報酬付きナップサック最適化</a>
1. （★3／diff <font color="blue">1959</font>／1問）<a href="#スライド最小化" class="tag">スライド最小化</a>
1. （★3／diff <font color="blue">1960</font>／2問）<a href="#モノイド演算に関する区間取得" class="tag">モノイド演算に関する区間取得</a>
...
1. （★3／diff <font color="yellowgreen">2081</font>／1問）<a href="#ヤング図形の転置" class="tag">ヤング図形の転置</a>
1. （★3／diff <font color="yellowgreen">2105</font>／4問）<a href="#ポラードの$\rho$" class="tag">ポラードの$\rho$</a>
1. （★3／diff <font color="yellowgreen">2107</font>／2問）<a href="#分割数計算" class="tag">分割数計算</a>
...
1. （★3／diff <font color="yellowgreen">2148</font>／2問）<a href="#関数のグラフ形状の変化イベント走査による差分計算" class="tag">関数のグラフ形状の変化イベント走査による差分計算</a>
1. （★3／diff <font color="yellowgreen">2152</font>／2問）<a href="#最近共通祖先計算" class="tag">最近共通祖先計算</a>／LCA計算
1. （★3／diff <font color="yellowgreen">2164</font>／5問）<a href="#inplace DP" class="tag">inplace DP</a>
...
1. （★3／diff <font color="yellowgreen">2206</font>／17問）<a href="#DPのデータ構造高速化" class="tag">DPのデータ構造高速化</a>
...
1. （★3／diff <font color="yellowgreen">2220</font>／3問）<a href="#重複選択可ナップサック割り当て数え上げ" class="tag">重複選択可ナップサック割り当て数え上げ</a>
...
1. （★3／diff <font color="yellowgreen">2309</font>／1問）<a href="#配列のリアクティブによる特定" class="tag">配列のリアクティブによる特定</a>
...
1. （★3／diff <font color="yellowgreen">2320</font>／7問）<a href="#ローリングハッシュ" class="tag">ローリングハッシュ</a>
...
1. （★3／diff <font color="yellowgreen">2351</font>／2問）<a href="#小数型の許容誤差付き二分探索・二分法" class="tag">小数型の許容誤差付き二分探索・二分法</a>
...
1. （★3／diff <font color="yellowgreen">2361</font>／2問）<a href="#座標のリアクティブによる特定" class="tag">座標のリアクティブによる特定</a>
...
1. （★3／diff <font color="yellowgreen">2392</font>／4問）<a href="#全方位木DP" class="tag">全方位木DP</a>
1. （★3／diff <font color="yellowgreen">2393</font>／1問）<a href="#剰余の法を止めた総和計算" class="tag">剰余の法を止めた総和計算</a>
1. （★3／diff <font color="yellowgreen">2397</font>／1問）<a href="#二項係数・順列の第１引数を渡る総和計算" class="tag">二項係数・順列の第１引数を渡る総和計算</a>
1. （★3／diff <font color="orange">2411</font>／1問）<a href="#コストなしナップサック割り当て数え上げ" class="tag">コストなしナップサック割り当て数え上げ</a>
1. （★3／diff <font color="orange">2411</font>／1問）<a href="#選択回数上限付き重複選択可ナップサック割り当て数え上げ" class="tag">選択回数上限付き重複選択可ナップサック割り当て数え上げ</a>
1. （★3／diff <font color="orange">2411</font>／1問）<a href="#部分列DP" class="tag">部分列DP</a>
1. （★3／diff <font color="orange">2411</font>／1問）<a href="#複数価値ナップサック割り当て数え上げ" class="tag">複数価値ナップサック割り当て数え上げ</a>
...
1. （★3／diff <font color="orange">2471</font>／2問）<a href="#分枝限定法" class="tag">分枝限定法</a>
...
1. （★3／diff <font color="orange">2581</font>／1問）<a href="#スタック" class="tag">スタック</a>／stack
1. （★3／diff <font color="orange">2656</font>／3問）<a href="#準同型" class="tag">準同型</a>
1. （★3／diff <font color="orange">2729</font>／2問）<a href="#区間乗算更新" class="tag">区間乗算更新</a>
...
1. （★3／diffデータなし／1問）<a href="#1の原始根を用いた文字種シフトの実装" class="tag">1の原始根を用いた文字種シフトの実装</a>
1. （★3／diffデータなし／1問）<a href="#部分列の二項関係をデータ構造で管理" class="tag">部分列の二項関係をデータ構造で管理</a>
...
1. （★3.1／diff <font color="yellowgreen">2218</font>／7問）<a href="#双対セグメント木" class="tag">双対セグメント木</a>
1. （★3.1／diff <font color="yellowgreen">2305</font>／4問）<a href="#約数ゼータ変換" class="tag">約数ゼータ変換</a>
1. （★3.1／diff <font color="yellowgreen">2307</font>／3問）<a href="#区間kth取得" class="tag">区間kth取得</a>
1. （★3.1／diff <font color="yellowgreen">2325</font>／5問）<a href="#メビウスの反転公式" class="tag">メビウスの反転公式</a>
1. （★3.1／diff <font color="yellowgreen">2325</font>／5問）<a href="#メビウス変換" class="tag">メビウス変換</a>
...
1. （★3.2／diff <font color="yellowgreen">2292</font>／2問）<a href="#単位の分解" class="tag">単位の分解</a>
...
1. （★3.2／diff <font color="orange">2454</font>／5問）<a href="#区間を中間で分割してマージ" class="tag">区間を中間で分割してマージ</a>
1. （★3.2／diff <font color="orange">2504</font>／4問）<a href="#約数メビウス変換" class="tag">約数メビウス変換</a>
1. （★3.2／diff <font color="orange">2612</font>／2問）<a href="#第二種スターリング数計算" class="tag">第二種スターリング数計算</a>
...
1. （★3.3／diff <font color="orange">2486</font>／14問）<a href="#分割統治法（狭義：devide-and-conquer）" class="tag">分割統治法（狭義：devide-and-conquer）</a>
1. （★3.3／diff <font color="orange">2557</font>／11問）<a href="#桁DP" class="tag">桁DP</a>
...
1. （★3.3／diff <font color="orange">2687</font>／4問）<a href="#遅延セグメント木" class="tag">遅延セグメント木</a>／遅延セグ木
...
1. （★4／diff <font color="orange">2583</font>／2問）<a href="#01列とヤング図形の対応" class="tag">01列とヤング図形の対応</a>
1. （★4／diff <font color="orange">2583</font>／2問）<a href="#01列と単調増加列・分割の対応" class="tag">01列と単調増加列・分割の対応</a>
...
- 全体: ★1.1／diff <font color="brown">770</font>
- 2024年: ★1／diff <font color="green">815</font>
...
- <a href="https://yukicoder.me/problems/no/2945">No.2945 Namiki Secondary School</a> (yukicoder contest 451 (並木中等プログラミングコンテスト 2024) (2024-10-25) - A問題、diff <font color="green">1174</font>)
...
- 全体: ★1.2／diff <font color="brown">712</font>
- 2024年: ★1.2／diff <font color="brown">789</font>
...
- <a href="https://yukicoder.me/problems/no/2919">No.2919 Welcome to The Below Green Contenst</a> (yukicoder contest 第3回緑以下コンテスト (2024-10-12) - A問題、diff <font color="brown">406</font>)
- <a href="https://yukicoder.me/problems/no/2920">No.2920 Blood Type</a> (yukicoder contest 第3回緑以下コンテスト (2024-10-12) - B問題、diff <font color="gray">311</font>)
- <a href="https://yukicoder.me/problems/no/2921">No.2921 Seated in Classroom</a> (yukicoder contest 第3回緑以下コンテスト (2024-10-12) - C問題、diff <font color="brown">670</font>)
- <a href="https://yukicoder.me/problems/no/2938">No.2938 Sigma Sigma Distance Distance Problem</a> (yukicoder contest 450 (2024-10-18) - B問題、diff <font color="brown">726</font>)
- <a href="https://yukicoder.me/problems/no/2945">No.2945 Namiki Secondary School</a> (yukicoder contest 451 (並木中等プログラミングコンテスト 2024) (2024-10-25) - A問題、diff <font color="green">1174</font>)
...
　
<h2 id="積のオーバーフロー回避">7. 積のオーバーフロー回避</h2>

### 難易度統計

「積のオーバーフロー回避」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★1.2／diff <font color="green">1002</font>
- 2024年: ★1.2／diff <font color="green">1002</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし

### レベル別問題一覧

「積のオーバーフロー回避」を主たる解法に含む問題のレベルごとの一覧です。

##### ★

- <a href="https://yukicoder.me/problems/no/2937">No.2937 Sigma Plus Problem</a> (yukicoder contest 450 (2024-10-18) - A問題、diff <font color="green">978</font>)
...
- 全体: ★1.3／diff <font color="brown">798</font>
- 2024年: ★1／diff <font color="green">978</font>
...
　
<h2 id="64bit整数">10. 64bit整数</h2>

### 難易度統計

「64bit整数」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★1.3／diff <font color="green">911</font>
- 2024年: ★1.3／diff <font color="green">979</font>
...
- <a href="https://yukicoder.me/problems/no/2647">No.2647 [Cherry 6th Tune A] Wind</a> (yukicoder contest 418 (Re: start!) (2024-02-23) - A問題、diff <font color="brown">783</font>)
- <a href="https://yukicoder.me/problems/no/2922">No.2922 Rose Garden</a> (yukicoder contest 第3回緑以下コンテスト (2024-10-12) - D問題、diff <font color="green">837</font>)
- <a href="https://yukicoder.me/problems/no/2937">No.2937 Sigma Plus Problem</a> (yukicoder contest 450 (2024-10-18) - A問題、diff <font color="green">978</font>)
...
- <a href="https://yukicoder.me/problems/no/2750">No.2750 Number of Prime Factors</a> (yukicoder contest 429 (2024-05-10) - B問題、diff <font color="green">1026</font>)
- <a href="https://yukicoder.me/problems/no/2923">No.2923 Mayor's Job</a> (yukicoder contest 第3回緑以下コンテスト (2024-10-12) - E問題、diff <font color="brown">786</font>)
- <a href="https://yukicoder.me/problems/no/2926">No.2926 Botaoshi</a> (yukicoder contest 第3回緑以下コンテスト (2024-10-12) - H問題、diff <font color="green">1081</font>)

　
<h2 id="平方根のfloor計算による平方数判定">11. 平方根のfloor計算による平方数判定</h2>

### 難易度統計

「平方根のfloor計算による平方数判定」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★1.5／diff <font color="brown">426</font>
...
　
<h2 id="コスト１ナップサック最適化">12. コスト１ナップサック最適化</h2>
...
　
<h2 id="全事象探索による確率・期待値計算">14. 全事象探索による確率・期待値計算</h2>

### 難易度統計

「全事象探索による確率・期待値計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★1.5／diff <font color="green">820</font>
- 2024年: ★1.5／diff <font color="green">820</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="選択順依存価値ナップサック最適化">16. 選択順依存価値ナップサック最適化</h2>
...
　
<h2 id="等差数列と等比数列の各点積の累積和計算">17. 等差数列と等比数列の各点積の累積和計算</h2>
...
　
<h2 id="符号なし64bit整数によるオーバーフロー回避">19. 符号なし64bit整数によるオーバーフロー回避</h2>

### 難易度統計

「符号なし64bit整数によるオーバーフロー回避」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★1.5／diff <font color="green">1103</font>
- 2024年: ★1／diff <font color="green">978</font>
...
　
<h2 id="極限の打ち切り計算">21. 極限の打ち切り計算</h2>
...
　
<h2 id="一次式の最大・最小値計算">23. 一次式の最大・最小値計算</h2>
...
　
<h2 id="数値の文字列受け取り">25. 数値の文字列受け取り</h2>
...
　
<h2 id="経路全探索">26. 経路全探索</h2>

### 難易度統計

「経路全探索」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★1.7／diff <font color="green">1135</font>
- 2024年: ★1.7／diff <font color="green">1135</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
- <a href="https://yukicoder.me/problems/no/2928">No.2928 Gridpath</a> (yukicoder contest 第3回緑以下コンテスト (2024-10-12) - J問題、diff <font color="deepskyblue">1535</font>)

　
<h2 id="連結リスト">27. 連結リスト</h2>

### 難易度統計

「連結リスト」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★1.7／diff <font color="green">1187</font>
- 2024年: ★1.7／diff <font color="green">1187</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
- <a href="https://yukicoder.me/problems/no/2924">No.2924 <===Super Spaceship String===></a> (yukicoder contest 第3回緑以下コンテスト (2024-10-12) - F問題、diff <font color="green">1008</font>)
...
　
<h2 id="multiset">31. multiset</h2>

### 難易度統計

「multiset」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★1.7／diff <font color="deepskyblue">1520</font>
- 2024年: ★2／diff <font color="blue">1727</font>
...
- <a href="https://yukicoder.me/problems/no/2930">No.2930 Larger Mex</a> (yukicoder contest 第3回緑以下コンテスト (2024-10-12) - L問題、diff <font color="blue">1727</font>)

　
<h2 id="剰余計算を桁の線形和に帰着">32. 剰余計算を桁の線形和に帰着</h2>
...
- 全体: ★1.8／diff <font color="deepskyblue">1213</font>
- 2024年: ★1.7／diff <font color="green">1136</font>
...
　
<h2 id="二分探索による平方根のfloor計算">35. 二分探索による平方根のfloor計算</h2>

### 難易度統計

「二分探索による平方根のfloor計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★1.8／diff <font color="deepskyblue">1276</font>
- 2024年: ★1.5／diff <font color="brown">426</font>
- 2023年: ★2／diff <font color="deepskyblue">1559</font>
- 2022年: ★データなし／diffデータなし

### レベル別問題一覧

「二分探索による平方根のfloor計算」を主たる解法に含む問題のレベルごとの一覧です。
...
　
<h2 id="オーバーフロー回避">36. オーバーフロー回避</h2>

### 難易度統計

「オーバーフロー回避」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★1.8／diff <font color="deepskyblue">1412</font>
- 2024年: ★1.8／diff <font color="deepskyblue">1474</font>
- 2023年: ★2／diff <font color="deepskyblue">1228</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="シミュレーション">37. シミュレーション</h2>

### 難易度統計

「シミュレーション」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★1.9／diff <font color="deepskyblue">1329</font>
- 2024年: ★1.8／diff <font color="deepskyblue">1463</font>
...
- <a href="https://yukicoder.me/problems/no/2731">No.2731 Two Colors</a> (yukicoder contest 428 (2024-04-19) - D問題、diff <font color="deepskyblue">1442</font>)
- <a href="https://yukicoder.me/problems/no/2804">No.2804 Fixer And Ratism</a> (yukicoder contest 436 ('09 Contest 002 day1) (2024-07-12) - B問題、diff <font color="blue">1779</font>)
- <a href="https://yukicoder.me/problems/no/2927">No.2927 Reverse Polish  Equation</a> (yukicoder contest 第3回緑以下コンテスト (2024-10-12) - I問題、diff <font color="blue">1824</font>)
...
　
<h2 id="指定序数の値の計算や指定要素以下・未満の要素数え上げや一次元最近点計算をソートに帰着">39. 指定序数の値の計算や指定要素以下・未満の要素数え上げや一次元最近点計算をソートに帰着</h2>

### 難易度統計

「指定序数の値の計算や指定要素以下・未満の要素数え上げや一次元最近点計算をソートに帰着」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
...
「指定序数の値の計算や指定要素以下・未満の要素数え上げや一次元最近点計算をソートに帰着」を主たる解法に含む問題のレベルごとの一覧です。
...
　
<h2 id="極小互換表示">40. 極小互換表示</h2>

### 難易度統計

「極小互換表示」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2／diff <font color="green">849</font>
- 2024年: ★データなし／diffデータなし
- 2023年: ★2／diff <font color="green">849</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="底辺と高さを用いた三角形の面積計算">42. 底辺と高さを用いた三角形の面積計算</h2>
...
　
<h2 id="始切片の比較を最大要素の比較に帰着">48. 始切片の比較を最大要素の比較に帰着</h2>
...
　
<h2 id="lower_bound・upper_bound取得">49. lower_bound・upper_bound取得</h2>
...
　
<h2 id="商の剰余計算を大きい法に帰着">50. 商の剰余計算を大きい法に帰着</h2>
...
　
<h2 id="階乗による多項係数計算">51. 階乗による多項係数計算</h2>
...
　
<h2 id="平方根のfloor計算">52. 平方根のfloor計算</h2>

### 難易度統計

「平方根のfloor計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2／diff <font color="deepskyblue">1374</font>
- 2024年: ★1.5／diff <font color="brown">426</font>
...
　
<h2 id="非連結性を壁の８方向移動による連結性に翻訳">53. 非連結性を壁の８方向移動による連結性に翻訳</h2>
...
- 全体: ★2／diff <font color="deepskyblue">1390</font>
- 2024年: ★1.7／diff <font color="deepskyblue">1207</font>
- 2023年: ★2／diff <font color="deepskyblue">1301</font>
- 2022年: ★2.4／diff <font color="blue">1856</font>
...
　
<h2 id="一次方程式・不等式の求解">55. 一次方程式・不等式の求解</h2>
...
　
<h2 id="順列のリアクティブによる特定">56. 順列のリアクティブによる特定</h2>
...
- 2024年: ★2／diff <font color="deepskyblue">1440</font>
...
- <a href="https://yukicoder.me/problems/no/2803">No.2803 Bocching Star</a> (yukicoder contest 436 ('09 Contest 002 day1) (2024-07-12) - A問題、diff <font color="green">939</font>)
- <a href="https://yukicoder.me/problems/no/2923">No.2923 Mayor's Job</a> (yukicoder contest 第3回緑以下コンテスト (2024-10-12) - E問題、diff <font color="brown">786</font>)
- <a href="https://yukicoder.me/problems/no/2947">No.2947 Sing a Song</a> (yukicoder contest 451 (並木中等プログラミングコンテスト 2024) (2024-10-25) - C問題、diff <font color="deepskyblue">1389</font>)
...
　
<h2 id="最小公倍数の約数関係判定を最大公約数の最小公倍数計算に帰着">58. 最小公倍数の約数関係判定を最大公約数の最小公倍数計算に帰着</h2>
...
　
<h2 id="平方数列の累積和計算">61. 平方数列の累積和計算</h2>

### 難易度統計

「平方数列の累積和計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2／diff <font color="deepskyblue">1488</font>
- 2024年: ★2／diff <font color="deepskyblue">1488</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
- <a href="https://yukicoder.me/problems/no/2941">No.2941 Sigma Music Game Score Problem</a> (yukicoder contest 450 (2024-10-18) - E問題、diff <font color="deepskyblue">1488</font>)
...
　
<h2 id="重複選択可ナップサック最適化">63. 重複選択可ナップサック最適化</h2>
...
　
<h2 id="外積計算">65. 外積計算</h2>

### 難易度統計

「外積計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2／diff <font color="deepskyblue">1509</font>
- 2024年: ★1.2／diff <font color="brown">792</font>
- 2023年: ★2.7／diff <font color="yellowgreen">2226</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="文字列のリアクティブによる特定">66. 文字列のリアクティブによる特定</h2>
...
　
<h2 id="ソート前の添字復元">67. ソート前の添字復元</h2>
...
　
<h2 id="素因数分解による最小公倍数計算">68. 素因数分解による最小公倍数計算</h2>
...
　
<h2 id="bool値のリアクティブによる特定">70. bool値のリアクティブによる特定</h2>
...
　
<h2 id="質問の全探索による質問決定">71. 質問の全探索による質問決定</h2>
...
　
<h2 id="グラフの構築">72. グラフの構築</h2>

### 難易度統計

「グラフの構築」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2／diff <font color="blue">1608</font>
- 2024年: ★2／diff <font color="blue">1608</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
- <a href="https://yukicoder.me/problems/no/2929">No.2929 Miracle Branch</a> (yukicoder contest 第3回緑以下コンテスト (2024-10-12) - K問題、diff <font color="blue">1608</font>)

　
<h2 id="木の構築">73. 木の構築</h2>
...
　
<h2 id="多次元コストを一次元に翻訳">74. 多次元コストを一次元に翻訳</h2>
...
　
<h2 id="倍数判定を約数列挙に帰着">75. 倍数判定を約数列挙に帰着</h2>
...
　
<h2 id="区間要素数取得を指定要素以下・未満の要素数え上げに帰着">76. 区間要素数取得を指定要素以下・未満の要素数え上げに帰着</h2>

### 難易度統計

「区間要素数取得を指定要素以下・未満の要素数え上げに帰着」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
...
「区間要素数取得を指定要素以下・未満の要素数え上げに帰着」を主たる解法に含む問題のレベルごとの一覧です。
...
　
<h2 id="必勝戦略のリアクティブ化">77. 必勝戦略のリアクティブ化</h2>

### 難易度統計

「必勝戦略のリアクティブ化」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2／diff <font color="blue">1835</font>
- 2024年: ★1.5／diff <font color="green">1180</font>
- 2023年: ★データなし／diffデータなし
...
- <a href="https://yukicoder.me/problems/no/2925">No.2925 2-Letter Shiritori</a> (yukicoder contest 第3回緑以下コンテスト (2024-10-12) - G問題、diff <font color="green">1180</font>)
...
　
<h2 id="法B係数連立一次方程式の解の構築">78. 法B係数連立一次方程式の解の構築</h2>
...
　
<h2 id="単調関数のファイバーの緩和計算">81. 単調関数のファイバーの緩和計算</h2>

### 難易度統計

「単調関数のファイバーの緩和計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.1／diff <font color="deepskyblue">1332</font>
- 2024年: ★2／diff <font color="deepskyblue">1218</font>
- 2023年: ★2.5／diff <font color="deepskyblue">1560</font>
- 2022年: ★データなし／diffデータなし
...
- 全体: ★2.1／diff <font color="deepskyblue">1340</font>
- 2024年: ★1.6／diff <font color="green">824</font>
...
　
<h2 id="多次元コストナップサック最適化">84. 多次元コストナップサック最適化</h2>
...
　
<h2 id="等差数列の累積和計算">85. 等差数列の累積和計算</h2>

### 難易度統計

「等差数列の累積和計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.1／diff <font color="deepskyblue">1521</font>
- 2024年: ★2／diff <font color="blue">1622</font>
...
- 全体: ★2.1／diff <font color="deepskyblue">1529</font>
- 2024年: ★2.1／diff <font color="blue">1816</font>
- 2023年: ★2.2／diff <font color="deepskyblue">1543</font>
- 2022年: ★1.5／diff <font color="brown">588</font>
...
　
<h2 id="決め打ちによる構築">88. 決め打ちによる構築</h2>
...
　
<h2 id="連長圧縮">90. 連長圧縮</h2>

### 難易度統計

「連長圧縮」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.1／diff <font color="blue">1631</font>
- 2024年: ★2／diff <font color="deepskyblue">1574</font>
...
- <a href="https://yukicoder.me/problems/no/2076">No.2076 Concon Substrings (ConVersion)</a> (yukicoder contest 360 (2022-09-16) - G問題、diff <font color="orange">2620</font>)
- <a href="https://yukicoder.me/problems/no/2950">No.2950 Max Min Product</a> (yukicoder contest 451 (並木中等プログラミングコンテスト 2024) (2024-10-25) - F問題、diff <font color="orange">2581</font>)

　
<h2 id="01列・部分集合の構築">91. 01列・部分集合の構築</h2>
...
　
<h2 id="巡回置換表示">94. 巡回置換表示</h2>

### 難易度統計

「巡回置換表示」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.2／diff <font color="deepskyblue">1312</font>
- 2024年: ★データなし／diffデータなし
- 2023年: ★2.2／diff <font color="deepskyblue">1312</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="操作回数上限以内の達成可能性判定を操作回数最小値計算に帰着">96. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#操作回数上限以内の達成可能性判定を操作回数最小値計算に帰着">操作回数上限以内の達成可能性判定を操作回数最小値計算に帰着</a></h2>
...
　
<h2 id="連結成分取得">100. 連結成分取得</h2>

### 難易度統計

「連結成分取得」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.2／diff <font color="deepskyblue">1450</font>
- 2024年: ★2.3／diff <font color="blue">1647</font>
...
- <a href="https://yukicoder.me/problems/no/2946">No.2946 Puyo</a> (yukicoder contest 451 (並木中等プログラミングコンテスト 2024) (2024-10-25) - B問題、diff <font color="deepskyblue">1235</font>)
...
　
<h2 id="区間選択ナップサック最適化">101. 区間選択ナップサック最適化</h2>
...
　
<h2 id="可負コストナップサック最適化">102. 可負コストナップサック最適化</h2>
...
　
<h2 id="操作を数値に翻訳">103. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#操作を数値に翻訳">操作を数値に翻訳</a></h2>
...
　
<h2 id="約数列挙">104. 約数列挙</h2>

### 難易度統計

「約数列挙」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.2／diff <font color="deepskyblue">1498</font>
- 2024年: ★2.3／diff <font color="deepskyblue">1481</font>
...
　
<h2 id="ナップサック最適化">105. ナップサック最適化</h2>
...
　
<h2 id="外積による三角形の面積計算">107. 外積による三角形の面積計算</h2>
...
　
<h2 id="幅優先探索">108. 幅優先探索</h2>

### 難易度統計

「幅優先探索」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.2／diff <font color="deepskyblue">1545</font>
- 2024年: ★2.3／diff <font color="blue">1722</font>
...
　
<h2 id="小数計算を整数に帰着">109. 小数計算を整数に帰着</h2>

### 難易度統計

「小数計算を整数に帰着」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.2／diff <font color="deepskyblue">1576</font>
- 2024年: ★2.3／diff <font color="blue">1698</font>
...
　
<h2 id="重複選択個数の線形関係式">110. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#重複選択個数の線形関係式">重複選択個数の線形関係式</a></h2>
...
　
<h2 id="素数列による試し割り法">113. 素数列による試し割り法</h2>
...
　
<h2 id="複数底の位取り記法表示">114. 複数底の位取り記法表示</h2>
...
　
<h2 id="選択肢の分割・纏め上げで良いケースに帰着">115. 選択肢の分割・纏め上げで良いケースに帰着</h2>
...
　
<h2 id="冪乗による根号消去">117. 冪乗による根号消去</h2>

### 難易度統計

「冪乗による根号消去」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.2／diff <font color="blue">1800</font>
- 2024年: ★3／diff <font color="orange">2419</font>
- 2023年: ★1.5／diff <font color="green">1182</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="不定方程式の因数分解">118. 不定方程式の因数分解</h2>
...
　
<h2 id="ルジャンドルの公式">119. ルジャンドルの公式</h2>

### 難易度統計

「ルジャンドルの公式」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.3／diff <font color="deepskyblue">1414</font>
- 2024年: ★3／diff <font color="deepskyblue">1406</font>
- 2023年: ★2／diff <font color="deepskyblue">1419</font>
- 2022年: ★データなし／diffデータなし
...
- <a href="https://yukicoder.me/problems/no/2380">No.2380 Sylow P-subgroup</a> (yukicoder contest 397(群論コンテスト) (2023-07-14) - B問題、diff <font color="deepskyblue">1233</font>)
...
　
<h2 id="ナップサックDP">120. ナップサックDP</h2>
...
　
<h2 id="コストなしナップサック最適化">122. コストなしナップサック最適化</h2>
...
　
<h2 id="素集合データ構造">123. 素集合データ構造</h2>

### 難易度統計

「素集合データ構造」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.3／diff <font color="deepskyblue">1515</font>
- 2024年: ★2.4／diff <font color="blue">1787</font>
- 2023年: ★2.1／diff <font color="deepskyblue">1321</font>
- 2022年: ★2.5／diff <font color="deepskyblue">1486</font>
...
　
<h2 id="余事象に注目">124. 余事象に注目</h2>

### 難易度統計

「余事象に注目」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.3／diff <font color="deepskyblue">1565</font>
- 2024年: ★2.3／diff <font color="blue">1696</font>
- 2023年: ★2.3／diff <font color="deepskyblue">1526</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="素因数分解による約数列挙">125. 素因数分解による約数列挙</h2>

### 難易度統計

「素因数分解による約数列挙」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.3／diff <font color="deepskyblue">1565</font>
- 2024年: ★2.5／diff <font color="blue">1651</font>
- 2023年: ★2.1／diff <font color="deepskyblue">1388</font>
- 2022年: ★2.5／diff <font color="yellowgreen">2291</font>
...
　
<h2 id="最大公約数による最小公倍数計算">126. 最大公約数による最小公倍数計算</h2>
...
　
<h2 id="試し割り法">129. 試し割り法</h2>

### 難易度統計

「試し割り法」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.3／diff <font color="blue">1633</font>
- 2024年: ★2.5／diff <font color="blue">1844</font>
- 2023年: ★2.2／diff <font color="deepskyblue">1478</font>
- 2022年: ★2.5／diff <font color="yellowgreen">2291</font>
...
- <a href="https://yukicoder.me/problems/no/2379">No.2379 Burnside's Theorem</a> (yukicoder contest 397(群論コンテスト) (2023-07-14) - A問題、diff <font color="brown">719</font>)
- <a href="https://yukicoder.me/problems/no/2417">No.2417 Div Count</a> (MMA Contest 016 (2023-08-12) - D問題、diff <font color="brown">781</font>)
...
　
<h2 id="ヘルド・カープ法">131. ヘルド・カープ法</h2>

### 難易度統計

「ヘルド・カープ法」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.3／diff <font color="blue">1687</font>
- 2024年: ★2.5／diff <font color="blue">1753</font>
- 2023年: ★2.2／diff <font color="blue">1621</font>
- 2022年: ★データなし／diffデータなし
...
- <a href="https://yukicoder.me/problems/no/2375">No.2375 watasou and hibit's baseball</a> (yukicoder contest 396 (Asakatsu Presents 2) (2023-07-07) - E問題、diff <font color="blue">1890</font>)
- <a href="https://yukicoder.me/problems/no/2948">No.2948 move move rotti</a> (yukicoder contest 451 (並木中等プログラミングコンテスト 2024) (2024-10-25) - D問題、diff <font color="blue">1778</font>)
...
- 2023年: ★2.3／diff <font color="blue">1742</font>
- 2022年: ★3.3／diff <font color="orange">2412</font>
...
　
<h2 id="二・多項係数を組み合わせに翻訳">133. 二・多項係数を組み合わせに翻訳</h2>
...
　
<h2 id="法B係数連立一次方程式の解の存在判定">134. 法B係数連立一次方程式の解の存在判定</h2>
...
　
<h2 id="動的mod">135. 動的mod</h2>

### 難易度統計

「動的mod」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.3／diff <font color="blue">1758</font>
- 2024年: ★2.3／diff <font color="blue">1812</font>
- 2023年: ★2.3／diff <font color="blue">1704</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="変数決め打ち">137. 変数決め打ち</h2>

### 難易度統計

「変数決め打ち」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.3／diff <font color="blue">1782</font>
- 2024年: ★2.4／diff <font color="blue">1887</font>
...
　
<h2 id="約数計数関数による計算量評価">138. 約数計数関数による計算量評価</h2>
...
　
<h2 id="貪欲法による構築">139. 貪欲法による構築</h2>

### 難易度統計

「貪欲法による構築」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.3／diff <font color="blue">1841</font>
- 2024年: ★2.7／diff <font color="yellowgreen">2373</font>
- 2023年: ★1.5／diff <font color="brown">779</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="操作コスト最小化を最短経路長計算に帰着">140. 操作コスト最小化を最短経路長計算に帰着</h2>
...
　
<h2 id="グラフの状態や目的地の変化を有向辺に翻訳">141. グラフの状態や目的地の変化を有向辺に翻訳</h2>
...
　
<h2 id="グラフの頂点の次数計算">142. グラフの頂点の次数計算</h2>
...
　
<h2 id="門松列DP">143. 門松列DP</h2>

### 難易度統計

「門松列DP」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.4／diff <font color="deepskyblue">1437</font>
- 2024年: ★2.5／diff <font color="blue">1957</font>
...
　
<h2 id="配列の構築">144. 配列の構築</h2>

### 難易度統計

「配列の構築」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.4／diff <font color="deepskyblue">1584</font>
- 2024年: ★2.5／diff <font color="blue">1830</font>
- 2023年: ★2／diff <font color="green">1048</font>
...
　
<h2 id="ド・モルガンの法則">145. ド・モルガンの法則</h2>

### 難易度統計

「ド・モルガンの法則」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.4／diff <font color="blue">1611</font>
- 2024年: ★2.5／diff <font color="deepskyblue">1509</font>
- 2023年: ★2.4／diff <font color="blue">1626</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="経路数え上げ">146. 経路数え上げ</h2>

### 難易度統計

「経路数え上げ」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.4／diff <font color="blue">1650</font>
- 2024年: ★2.5／diff <font color="blue">1778</font>
...
- <a href="https://yukicoder.me/problems/no/2932">No.2932 えっえっ嘘嘘嘘待って待って待って？？？えマジで？ほんとに？マジでやばすぎなんだけど？えっおっほんとにこんなにDPしちゃっていいんですかい？？？マジでやばすぎなんだけど？？？</a> (yukicoder contest 第3回緑以下コンテスト エキストラ (2024-10-12) - B問題、diffデータなし)
...
　
<h2 id="bool値の充足可能性判定">147. bool値の充足可能性判定</h2>
...
　
<h2 id="01列と非負整数の対応">148. 01列と非負整数の対応</h2>

### 難易度統計

「01列と非負整数の対応」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.4／diff <font color="blue">1692</font>
- 2024年: ★2.2／diff <font color="deepskyblue">1458</font>
...
　
<h2 id="尺取り法">149. 尺取り法</h2>

### 難易度統計

「尺取り法」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.4／diff <font color="blue">1725</font>
- 2024年: ★2.2／diff <font color="blue">1602</font>
...
　
<h2 id="累積積による冪乗・階乗計算">150. 累積積による冪乗・階乗計算</h2>

### 難易度統計

「累積積による冪乗・階乗計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.4／diff <font color="blue">1740</font>
- 2024年: ★2.4／diff <font color="blue">1773</font>
- 2023年: ★2.4／diff <font color="blue">1689</font>
...
- <a href="https://yukicoder.me/problems/no/2377">No.2377 SUM AND XOR on Tree</a> (yukicoder contest 396 (Asakatsu Presents 2) (2023-07-07) - G問題、diff <font color="yellowgreen">2103</font>)
- <a href="https://yukicoder.me/problems/no/2511">No.2511 Mountain Sequence</a> (yukicoder contest 409 (2023-10-20) - D問題、diff <font color="yellowgreen">2273</font>)
- <a href="https://yukicoder.me/problems/no/2616">No.2616 中央番目の中央値</a> (yukicoder contest 416 (2024-01-26) - C問題、diff <font color="yellowgreen">2143</font>)
...
- <a href="https://yukicoder.me/problems/no/2951">No.2951 Similar to Mex</a> (yukicoder contest 451 (並木中等プログラミングコンテスト 2024) (2024-10-25) - G問題、diff <font color="orange">2581</font>)

　
<h2 id="集合管理">151. 集合管理</h2>

### 難易度統計

「集合管理」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.4／diff <font color="blue">1748</font>
- 2024年: ★2.2／diff <font color="deepskyblue">1571</font>
...
- <a href="https://yukicoder.me/problems/no/2684">No.2684 折々の色</a> (yukicoder contest 422 (第１回 競技プログラミング講習会作問企画コンテスト) (2024-03-20) - F問題、diff <font color="blue">1790</font>)
- <a href="https://yukicoder.me/problems/no/2873">No.2873 Kendall's Tau</a> (yukicoder contest 444 (2024-09-06) - D問題、diff <font color="blue">1712</font>)
- <a href="https://yukicoder.me/problems/no/2942">No.2942 Sigma Music Game Level Problem</a> (yukicoder contest 450 (2024-10-18) - F問題、diff <font color="blue">1752</font>)
...
　
<h2 id="区間を切片の差に翻訳">152. 区間を切片の差に翻訳</h2>
...
　
<h2 id="等比数列の累積和計算">153. 等比数列の累積和計算</h2>
...
　
<h2 id="不変量に注目">154. 不変量に注目</h2>

### 難易度統計

「不変量に注目」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.4／diff <font color="blue">1765</font>
- 2024年: ★2.5／diff <font color="blue">1845</font>
- 2023年: ★2.2／diff <font color="deepskyblue">1456</font>
...
　
<h2 id="累積和">155. 累積和</h2>

### 難易度統計

「累積和」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.4／diff <font color="blue">1769</font>
- 2024年: ★2.5／diff <font color="blue">1917</font>
- 2023年: ★2.6／diff <font color="blue">1800</font>
...
- <a href="https://yukicoder.me/problems/no/2724">No.2724 Coprime Game 1</a> (yukicoder contest 427 (ゲーム問題コンテスト) (2024-04-12) - D問題、diff <font color="blue">1845</font>)
- <a href="https://yukicoder.me/problems/no/2931">No.2931 Shibuya 109</a> (yukicoder contest 第3回緑以下コンテスト エキストラ (2024-10-12) - A問題、diffデータなし)
...
　
<h2 id="損をしない変形">156. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#損をしない変形">損をしない変形</a></h2>
...
- 全体: ★2.4／diff <font color="blue">1813</font>
- 2024年: ★2.4／diff <font color="blue">1823</font>
...
　
<h2 id="リアクティブによる特定">159. リアクティブによる特定</h2>
...
　
<h2 id="良いケースに帰着">160. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#良いケースに帰着">良いケースに帰着</a></h2>
...
　
<h2 id="複数配列への範囲加算更新を１つの配列に纏め上げ">161. 複数配列への範囲加算更新を１つの配列に纏め上げ</h2>
...
　
<h2 id="部分和と補部分和の差の最小化">162. 部分和と補部分和の差の最小化</h2>
...
　
<h2 id="部分和の差の最小化">163. 部分和の差の最小化</h2>
...
　
<h2 id="符号全探索による絶対値計算">166. 符号全探索による絶対値計算</h2>
...
　
<h2 id="指定序数の値の計算を被覆の先頭項管理で処理">167. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#指定序数の値の計算を被覆の先頭項管理で処理">指定序数の値の計算を被覆の先頭項管理で処理</a></h2>
...
　
<h2 id="極小基本互換表示">168. 極小基本互換表示</h2>

### 難易度統計

「極小基本互換表示」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="deepskyblue">1550</font>
- 2024年: ★データなし／diffデータなし
- 2023年: ★2.5／diff <font color="deepskyblue">1550</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="素数列挙">170. 素数列挙</h2>

### 難易度統計

「素数列挙」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="deepskyblue">1553</font>
- 2024年: ★2.5／diff <font color="deepskyblue">1553</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="言及する成分数を最大化する質問">171. 言及する成分数を最大化する質問</h2>
...
　
<h2 id="strategy stealing argument">172. strategy stealing argument</h2>
...
　
<h2 id="倍数メビウス変換">173. 倍数メビウス変換</h2>
...
　
<h2 id="可負コストナップサック割り当て数え上げ">174. 可負コストナップサック割り当て数え上げ</h2>
...
　
<h2 id="可負価値ナップサック割り当て数え上げ">175. 可負価値ナップサック割り当て数え上げ</h2>
...
　
<h2 id="可負価値ナップサック最適化">176. 可負価値ナップサック最適化</h2>
...
　
<h2 id="不明な想定解">177. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#不明な想定解">不明な想定解</a></h2>
...
　
<h2 id="位取り記法による構築">178. 位取り記法による構築</h2>
...
　
<h2 id="ハミルトン路構築">179. ハミルトン路構築</h2>
...
　
<h2 id="配列を像・頻度表で管理">180. 配列を像・頻度表で管理</h2>

### 難易度統計

「配列を像・頻度表で管理」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1671</font>
...
　
<h2 id="マッチ度ごとに管理">181. マッチ度ごとに管理</h2>

### 難易度統計

「マッチ度ごとに管理」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1678</font>
- 2024年: ★2.7／diff <font color="yellowgreen">2135</font>
...
　
<h2 id="エラトステネスの篩">183. エラトステネスの篩</h2>

### 難易度統計

「エラトステネスの篩」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1703</font>
- 2024年: ★2.5／diff <font color="blue">1622</font>
- 2023年: ★2.5／diff <font color="blue">1887</font>
- 2022年: ★3／diff <font color="yellowgreen">2167</font>
...
　
<h2 id="指定序数の値の計算を指定要素以下・未満の要素数え上げに帰着">185. 指定序数の値の計算を指定要素以下・未満の要素数え上げに帰着</h2>

### 難易度統計

「指定序数の値の計算を指定要素以下・未満の要素数え上げに帰着」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1715</font>
- 2024年: ★2.5／diff <font color="green">1019</font>
- 2023年: ★2.1／diff <font color="blue">1637</font>
- 2022年: ★3.5／diff <font color="orange">2648</font>

### レベル別問題一覧

「指定序数の値の計算を指定要素以下・未満の要素数え上げに帰着」を主たる解法に含む問題のレベルごとの一覧です。
...
　
<h2 id="ミラー戦略">187. ミラー戦略</h2>

### 難易度統計

「ミラー戦略」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1744</font>
- 2024年: ★2.4／diff <font color="blue">1764</font>
...
　
<h2 id="ベルマン・フォード法">188. ベルマン・フォード法</h2>
...
　
<h2 id="一要素重複挿入更新">190. 一要素重複挿入更新</h2>

### 難易度統計

「一要素重複挿入更新」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1752</font>
- 2024年: ★2.5／diff <font color="blue">1752</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="部分集合DP">191. 部分集合DP</h2>

### 難易度統計

「部分集合DP」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1753</font>
- 2024年: ★2.5／diff <font color="blue">1753</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
- 2024年: ★2.4／diff <font color="blue">1724</font>
...
　
<h2 id="深さ優先探索">194. 深さ優先探索</h2>

### 難易度統計

「深さ優先探索」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1756</font>
- 2024年: ★1.9／diff <font color="deepskyblue">1420</font>
- 2023年: ★2.8／diff <font color="blue">1925</font>
- 2022年: ★データなし／diffデータなし
...
- <a href="https://yukicoder.me/problems/no/2949">No.2949 Product on Tree</a> (yukicoder contest 451 (並木中等プログラミングコンテスト 2024) (2024-10-25) - E問題、diff <font color="blue">1894</font>)
...
　
<h2 id="Vieta Jumping">197. Vieta Jumping</h2>
...
　
<h2 id="価値上限ありナップサック最適化">199. 価値上限ありナップサック最適化</h2>
...
　
<h2 id="操作・遷移の纏め上げ">200. 操作・遷移の纏め上げ</h2>

### 難易度統計

「操作・遷移の纏め上げ」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1782</font>
- 2024年: ★3／diff <font color="yellowgreen">2075</font>
...
　
<h2 id="bitごとに計算">201. bitごとに計算</h2>

### 難易度統計

「bitごとに計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1794</font>
- 2024年: ★2／diff <font color="deepskyblue">1392</font>
- 2023年: ★2.7／diff <font color="blue">1715</font>
...
- <a href="https://yukicoder.me/problems/no/2663">No.2663 Zero-Sum Submatrices</a> (yukicoder contest 420 (2024-03-08) - A問題、diff <font color="deepskyblue">1204</font>)
- <a href="https://yukicoder.me/problems/no/2828">No.2828 Remainder Game</a> (yukicoder contest 439 (2024-08-02) - B問題、diff <font color="blue">1696</font>)
- <a href="https://yukicoder.me/problems/no/2939">No.2939 Sigma Popcount Problem</a> (yukicoder contest 450 (2024-10-18) - C問題、diff <font color="deepskyblue">1277</font>)
...
　
<h2 id="２種の数値を足し引きして１種に帰着">202. ２種の数値を足し引きして１種に帰着</h2>
...
　
<h2 id="あみだくじと置換の対応">203. あみだくじと置換の対応</h2>
...
　
<h2 id="階乗計算">206. 階乗計算</h2>

### 難易度統計

「階乗計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1813</font>
- 2024年: ★2.7／diff <font color="blue">1941</font>
- 2023年: ★2.5／diff <font color="blue">1760</font>
...
　
<h2 id="最大公約数計算">207. 最大公約数計算</h2>

### 難易度統計

「最大公約数計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1825</font>
- 2024年: ★2.1／diff <font color="deepskyblue">1525</font>
...
　
<h2 id="mex取得">208. mex取得</h2>

### 難易度統計

「mex取得」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1827</font>
- 2024年: ★2／diff <font color="blue">1727</font>
...
　
<h2 id="分割統治法（広義：decrease-and-conquer）">210. 分割統治法（広義：decrease-and-conquer）</h2>

### 難易度統計

「分割統治法（広義：decrease-and-conquer）」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1831</font>
- 2024年: ★2.6／diff <font color="blue">1979</font>
- 2023年: ★2.5／diff <font color="blue">1708</font>
- 2022年: ★2.6／diff <font color="blue">1957</font>
...
　
<h2 id="試行回数・順位の期待値を各試行の実施確率・各項の先着確率の和に帰着">212. 試行回数・順位の期待値を各試行の実施確率・各項の先着確率の和に帰着</h2>
...
- 全体: ★2.5／diff <font color="blue">1836</font>
- 2024年: ★2.4／diff <font color="blue">1809</font>
- 2023年: ★2.5／diff <font color="blue">1643</font>
...
　
<h2 id="modint型">214. modint型</h2>

### 難易度統計

「modint型」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1838</font>
- 2024年: ★2.5／diff <font color="blue">1859</font>
- 2023年: ★2.4／diff <font color="blue">1724</font>
...
　
<h2 id="オイラーの定理による逆元計算">216. オイラーの定理による逆元計算</h2>
...
　
<h2 id="合成数を法とする逆元計算">217. 合成数を法とする逆元計算</h2>
...
　
<h2 id="エラトステネスの篩による素数判定">218. エラトステネスの篩による素数判定</h2>
...
　
<h2 id="素数計数関数前計算">219. 素数計数関数前計算</h2>
...
　
<h2 id="Dilworthの定理">221. Dilworthの定理</h2>
...
　
<h2 id="鎖への分割数の最小化">222. 鎖への分割数の最小化</h2>
...
　
<h2 id="ポテンシャル付き素集合データ構造">223. ポテンシャル付き素集合データ構造</h2>
...
　
<h2 id="素数を用いた構築">225. 素数を用いた構築</h2>

### 難易度統計

「素数を用いた構築」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1858</font>
- 2024年: ★2.3／diff <font color="blue">1756</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★3／diff <font color="yellowgreen">2167</font>
...
　
<h2 id="next DP">226. next DP</h2>

### 難易度統計

「next DP」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1859</font>
- 2024年: ★2.5／diff <font color="blue">1859</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="排他的被覆数え上げ">228. 排他的被覆数え上げ</h2>
...
　
<h2 id="冪乗計算">230. 冪乗計算</h2>

### 難易度統計

「冪乗計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1867</font>
- 2024年: ★2.5／diff <font color="blue">1847</font>
- 2023年: ★2.5／diff <font color="blue">1839</font>
...
- 2023年: ★2.7／diff <font color="blue">1973</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="最大・最小要素取得">232. 最大・最小要素取得</h2>

### 難易度統計

「最大・最小要素取得」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1869</font>
- 2024年: ★2.3／diff <font color="blue">1788</font>
- 2023年: ★2.7／diff <font color="blue">1990</font>
...
　
<h2 id="距離空間の重み付きグラフ化">233. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#距離空間の重み付きグラフ化">距離空間の重み付きグラフ化</a></h2>
...
- 全体: ★2.5／diff <font color="blue">1874</font>
- 2024年: ★2.5／diff <font color="deepskyblue">1570</font>
- 2023年: ★2.6／diff <font color="yellowgreen">2026</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="フェルマーの小定理">234. フェルマーの小定理</h2>
...
　
<h2 id="setprecision・format">235. setprecision・format</h2>
...
　
<h2 id="選択回数依存コスト重複選択可ナップサック最適化">238. 選択回数依存コスト重複選択可ナップサック最適化</h2>
...
　
<h2 id="bitDP">239. bitDP</h2>

### 難易度統計

「bitDP」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="blue">1923</font>
- 2024年: ★2.5／diff <font color="blue">1753</font>
- 2023年: ★2.5／diff <font color="blue">1897</font>
- 2022年: ★3／diff <font color="yellowgreen">2344</font>
...
　
<h2 id="多次元の最適化を一次元の最適化に帰着">240. 多次元の最適化を一次元の最適化に帰着</h2>
...
　
<h2 id="優先度付きキュー">243. 優先度付きキュー</h2>
...
　
<h2 id="位取り記法表示で全探索">245. 位取り記法表示で全探索</h2>
...
　
<h2 id="ワーシャル・フロイド法">248. ワーシャル・フロイド法</h2>

### 難易度統計

「ワーシャル・フロイド法」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="yellowgreen">2011</font>
- 2024年: ★2.5／diff <font color="blue">1717</font>
- 2023年: ★2.5／diff <font color="yellowgreen">2306</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="最大・最小要素削除">249. 最大・最小要素削除</h2>

### 難易度統計

「最大・最小要素削除」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="yellowgreen">2016</font>
...
　
<h2 id="テストケースの構築">250. テストケースの構築</h2>
...
　
<h2 id="独立事象の確率を積で計算">251. 独立事象の確率を積で計算</h2>
...
　
<h2 id="１つの桁・成分のみ特定する質問">252. １つの桁・成分のみ特定する質問</h2>
...
　
<h2 id="オイラーグラフ判定">253. オイラーグラフ判定</h2>
...
　
<h2 id="上限・下限値に言及する質問">254. 上限・下限値に言及する質問</h2>
...
　
<h2 id="B進法位取り記法と法Bベクトルの対応">255. B進法位取り記法と法Bベクトルの対応</h2>
...
　
<h2 id="整数のリアクティブによる特定">256. 整数のリアクティブによる特定</h2>
...
　
<h2 id="定数倍メモリ削減">259. 定数倍メモリ削減</h2>
...
　
<h2 id="線分の交差判定">260. 線分の交差判定</h2>

### 難易度統計

「線分の交差判定」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.5／diff <font color="yellowgreen">2306</font>
- 2024年: ★データなし／diffデータなし
- 2023年: ★2.5／diff <font color="yellowgreen">2306</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="個数上限１複数ナップサック最適化">261. 個数上限１複数ナップサック最適化</h2>
...
　
<h2 id="全順序集合を状態に持つゲームをP状態とN状態の区間に分割">262. 全順序集合を状態に持つゲームをP状態とN状態の区間に分割</h2>
...
　
<h2 id="必勝戦略のリアクティブによる特定">263. 必勝戦略のリアクティブによる特定</h2>
...
　
<h2 id="ラグランジュ補間">264. ラグランジュ補間</h2>
...
　
<h2 id="グランディ数計算">267. グランディ数計算</h2>
...
　
<h2 id="最終手番のターン数に注目">268. 最終手番のターン数に注目</h2>
...
　
<h2 id="付値計算">270. 付値計算</h2>

### 難易度統計

「付値計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1802</font>
- 2024年: ★2.5／diff <font color="blue">1707</font>
- 2023年: ★2.6／diff <font color="blue">1850</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="階乗による二項係数・多項係数計算">271. 階乗による二項係数・多項係数計算</h2>

### 難易度統計

「階乗による二項係数・多項係数計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1810</font>
- 2024年: ★2.7／diff <font color="blue">1984</font>
- 2023年: ★2.5／diff <font color="deepskyblue">1547</font>
- 2022年: ★2.2／diff <font color="blue">1641</font>

### レベル別問題一覧

「階乗による二項係数・多項係数計算」を主たる解法に含む問題のレベルごとの一覧です。
...
　
<h2 id="差分計算">272. 差分計算</h2>

### 難易度統計

「差分計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1816</font>
- 2024年: ★2.6／diff <font color="blue">1935</font>
- 2023年: ★2.4／diff <font color="deepskyblue">1553</font>
...
　
<h2 id="階乗逆元計算">275. 階乗逆元計算</h2>

### 難易度統計

「階乗逆元計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1826</font>
- 2024年: ★2.8／diff <font color="yellowgreen">2000</font>
...
　
<h2 id="next_permutation">276. next_permutation</h2>
...
　
<h2 id="合成による次元削減">277. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#合成による次元削減">合成による次元削減</a></h2>
...
- 2023年: ★2.6／diff <font color="blue">1947</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="集合の変化イベント走査による差分計算">282. 集合の変化イベント走査による差分計算</h2>

### 難易度統計

「集合の変化イベント走査による差分計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1867</font>
- 2024年: ★2.6／diff <font color="blue">1791</font>
- 2023年: ★2.7／diff <font color="blue">1943</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="ナップサック分割統治">283. ナップサック分割統治</h2>
...
　
<h2 id="素因数分解による付値計算">284. 素因数分解による付値計算</h2>

### 難易度統計

「素因数分解による付値計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1894</font>
- 2024年: ★2.3／diff <font color="blue">1782</font>
- 2023年: ★2.8／diff <font color="blue">1968</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="逆元の再帰計算">285. 逆元の再帰計算</h2>

### 難易度統計

「逆元の再帰計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1914</font>
- 2024年: ★2.6／diff <font color="blue">1988</font>
- 2023年: ★2.5／diff <font color="blue">1749</font>
...
　
<h2 id="素数を法とする逆元計算">286. 素数を法とする逆元計算</h2>

### 難易度統計

「素数を法とする逆元計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1916</font>
- 2024年: ★2.6／diff <font color="blue">1971</font>
- 2023年: ★2.6／diff <font color="blue">1808</font>
...
　
<h2 id="フェルマーの小定理による逆元計算">287. フェルマーの小定理による逆元計算</h2>
...
　
<h2 id="動的計画法">288. 動的計画法</h2>

### 難易度統計

「動的計画法」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1942</font>
- 2024年: ★2.5／diff <font color="blue">1855</font>
- 2023年: ★2.7／diff <font color="blue">1935</font>
...
　
<h2 id="繰り返し二乗法">289. 繰り返し二乗法</h2>

### 難易度統計

「繰り返し二乗法」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1942</font>
- 2024年: ★2.7／diff <font color="yellowgreen">2063</font>
- 2023年: ★2.5／diff <font color="blue">1866</font>
...
　
<h2 id="包除原理">290. 包除原理</h2>

### 難易度統計

「包除原理」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1945</font>
- 2024年: ★2.3／diff <font color="blue">1842</font>
- 2023年: ★2.7／diff <font color="blue">1934</font>
...
　
<h2 id="倍数走査による約数列挙前計算">291. 倍数走査による約数列挙前計算</h2>

### 難易度統計

「倍数走査による約数列挙前計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1948</font>
- 2024年: ★2.5／diff <font color="blue">1680</font>
...
　
<h2 id="約数走査を倍数走査に帰着">292. 約数走査を倍数走査に帰着</h2>
...
　
<h2 id="imos法">294. imos法</h2>

### 難易度統計

「imos法」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1969</font>
- 2024年: ★2.5／diff <font color="yellowgreen">2024</font>
...
　
<h2 id="端から確定">296. 端から確定</h2>

### 難易度統計

「端から確定」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.6／diff <font color="blue">1998</font>
- 2024年: ★2.6／diff <font color="yellowgreen">2067</font>
- 2023年: ★2.6／diff <font color="blue">1944</font>
...
　
<h2 id="探索・求解アルゴリズムによる構築">297. 探索・求解アルゴリズムによる構築</h2>
...
　
<h2 id="剰余の被除数を止めた総和計算">298. 剰余の被除数を止めた総和計算</h2>

### 難易度統計

「剰余の被除数を止めた総和計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
...
「剰余の被除数を止めた総和計算」を主たる解法に含む問題のレベルごとの一覧です。
...
　
<h2 id="始点と終点からの最短経路長計算">300. 始点と終点からの最短経路長計算</h2>
...
　
<h2 id="アルゴリズムのクエリ化">302. アルゴリズムのクエリ化</h2>
...
　
<h2 id="最長単調増加部分列長計算">304. 最長単調増加部分列長計算</h2>
...
　
<h2 id="データを不変量別に分割して管理">305. データを不変量別に分割して管理</h2>

### 難易度統計

「データを不変量別に分割して管理」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.7／diff <font color="blue">1850</font>
- 2024年: ★2.5／diff <font color="blue">1908</font>
...
　
<h2 id="01列に翻訳">306. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#01列に翻訳">01列に翻訳</a></h2>
...
- 全体: ★2.7／diff <font color="blue">1874</font>
- 2024年: ★2.5／diff <font color="blue">1633</font>
- 2023年: ★2.6／diff <font color="blue">1992</font>
...
　
<h2 id="終点からの最短経路長計算">307. 終点からの最短経路長計算</h2>
...
　
<h2 id="表示可能性DP">308. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#表示可能性DP">表示可能性DP</a></h2>
...
　
<h2 id="区間和取得">309. 区間和取得</h2>

### 難易度統計

「区間和取得」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.7／diff <font color="blue">1898</font>
- 2024年: ★2.6／diff <font color="blue">1853</font>
- 2023年: ★2.6／diff <font color="blue">1886</font>
...
　
<h2 id="場合分けによるmax・min・絶対値計算">311. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#場合分けによるmax・min・絶対値計算">場合分けによるmax・min・絶対値計算</a></h2>
...
　
<h2 id="区間スケジューリング">313. 区間スケジューリング</h2>
...
　
<h2 id="商による付値計算">314. 商による付値計算</h2>
...
- 2023年: ★2.8／diff <font color="blue">1791</font>
- 2022年: ★2.2／diff <font color="blue">1641</font>
...
　
<h2 id="法B係数連立一次方程式の解の数え上げ">317. 法B係数連立一次方程式の解の数え上げ</h2>
...
　
<h2 id="区間加算更新">318. 区間加算更新</h2>

### 難易度統計

「区間加算更新」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.7／diff <font color="blue">1969</font>
- 2024年: ★2.5／diff <font color="blue">1942</font>
- 2023年: ★2.7／diff <font color="blue">1841</font>
...
　
<h2 id="最適化を各寄与の最適化に緩和">319. 最適化を各寄与の最適化に緩和</h2>

### 難易度統計

「最適化を各寄与の最適化に緩和」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.7／diff <font color="blue">1986</font>
- 2024年: ★2.7／diff <font color="yellowgreen">2062</font>
- 2023年: ★2.7／diff <font color="blue">1911</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="区間要素数取得">320. 区間要素数取得</h2>

### 難易度統計

「区間要素数取得」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.7／diff <font color="blue">1993</font>
- 2024年: ★2.5／diff <font color="blue">1853</font>
- 2023年: ★2.5／diff <font color="blue">1975</font>
...
　
<h2 id="数え上げを総和計算に帰着">321. 数え上げを総和計算に帰着</h2>

### 難易度統計

「数え上げを総和計算に帰着」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.7／diff <font color="blue">1994</font>
- 2024年: ★2.7／diff <font color="blue">1958</font>
- 2023年: ★2.7／diff <font color="blue">1919</font>
...
　
<h2 id="区間代入更新">322. 区間代入更新</h2>

### 難易度統計

「区間代入更新」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.7／diff <font color="blue">1995</font>
- 2024年: ★2.8／diff <font color="yellowgreen">2043</font>
...
　
<h2 id="区間和の指定された区間数え上げ">324. 区間和の指定された区間数え上げ</h2>
...
　
<h2 id="不変量を保つ戦略">325. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#不変量を保つ戦略">不変量を保つ戦略</a></h2>
...
　
<h2 id="緩和">326. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#緩和">緩和</a></h2>
...
- 全体: ★2.7／diff <font color="yellowgreen">2014</font>
- 2024年: ★2.5／diff <font color="blue">1728</font>
- 2023年: ★2.9／diff <font color="yellowgreen">2133</font>
...
　
<h2 id="商のfloorの分子を止めた総和計算">328. 商のfloorの分子を止めた総和計算</h2>

### 難易度統計

「商のfloorの分子を止めた総和計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.7／diff <font color="yellowgreen">2027</font>
- 2024年: ★2.5／diff <font color="blue">1661</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★3／diff <font color="yellowgreen">2393</font>

### レベル別問題一覧

「商のfloorの分子を止めた総和計算」を主たる解法に含む問題のレベルごとの一覧です。
...
　
<h2 id="描画可能性を実際に描画して判定">329. 描画可能性を実際に描画して判定</h2>
...
　
<h2 id="無向木の有向化">330. 無向木の有向化</h2>

### 難易度統計

「無向木の有向化」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.7／diff <font color="yellowgreen">2099</font>
- 2024年: ★2.2／diff <font color="blue">1850</font>
- 2023年: ★2.9／diff <font color="yellowgreen">2183</font>
- 2022年: ★データなし／diffデータなし
...
- 2024年: ★2.2／diff <font color="blue">1850</font>
- 2023年: ★2.9／diff <font color="yellowgreen">2208</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="倍数走査によるオイラー関数前計算">332. 倍数走査によるオイラー関数前計算</h2>
...
　
<h2 id="既存のアルゴリズムの変形">337. 既存のアルゴリズムの変形</h2>
...
　
<h2 id="頂点の纏め上げによる次元削減">339. 頂点の纏め上げによる次元削減</h2>
...
　
<h2 id="隣接行列による遷移計算">340. 隣接行列による遷移計算</h2>
...
　
<h2 id="リアクティブによるブラックボックス操作">341. リアクティブによるブラックボックス操作</h2>
...
　
<h2 id="上界制約を無視した数え上げを桁ごとに前計算">343. 上界制約を無視した数え上げを桁ごとに前計算</h2>

### 難易度統計

「上界制約を無視した数え上げを桁ごとに前計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.8／diff <font color="blue">1841</font>
- 2024年: ★2.8／diff <font color="blue">1841</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="指定要素以下・未満の要素数え上げを桁ごとの計算に帰着">345. 指定要素以下・未満の要素数え上げを桁ごとの計算に帰着</h2>

### 難易度統計

「指定要素以下・未満の要素数え上げを桁ごとの計算に帰着」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.8／diff <font color="blue">1912</font>
- 2024年: ★2.6／diff <font color="deepskyblue">1567</font>
- 2023年: ★3.1／diff <font color="yellowgreen">2171</font>
- 2022年: ★データなし／diffデータなし

### レベル別問題一覧

「指定要素以下・未満の要素数え上げを桁ごとの計算に帰着」を主たる解法に含む問題のレベルごとの一覧です。
...
　
<h2 id="sorted set">346. sorted set</h2>
...
　
<h2 id="ループ戦略">347. ループ戦略</h2>

### 難易度統計

「ループ戦略」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.8／diff <font color="blue">1926</font>
- 2024年: ★データなし／diffデータなし
- 2023年: ★2.8／diff <font color="blue">1926</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="小さいケースの構築を拡張">349. 小さいケースの構築を拡張</h2>
...
　
<h2 id="平面走査">350. 平面走査</h2>

### 難易度統計

「平面走査」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.8／diff <font color="yellowgreen">2004</font>
- 2024年: ★2.8／diff <font color="yellowgreen">2105</font>
- 2023年: ★2.7／diff <font color="blue">1856</font>
...
　
<h2 id="フェニック木">351. フェニック木</h2>

### 難易度統計

「フェニック木」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.8／diff <font color="yellowgreen">2014</font>
- 2024年: ★2.8／diff <font color="yellowgreen">2004</font>
- 2023年: ★2.6／diff <font color="blue">1947</font>
...
　
<h2 id="商のfloorの種類数による計算量評価">352. 商のfloorの種類数による計算量評価</h2>
...
　
<h2 id="区間の重複度計算">353. 区間の重複度計算</h2>
...
　
<h2 id="押し付け戦略">355. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#押し付け戦略">押し付け戦略</a></h2>
...
　
<h2 id="商のfloorの分母を止めた総和計算">356. 商のfloorの分母を止めた総和計算</h2>

### 難易度統計

「商のfloorの分母を止めた総和計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.8／diff <font color="yellowgreen">2066</font>
- 2024年: ★2.5／diff <font color="blue">1661</font>
- 2023年: ★2.5／diff <font color="blue">1891</font>
- 2022年: ★3.5／diff <font color="orange">2648</font>
...
「商のfloorの分母を止めた総和計算」を主たる解法に含む問題のレベルごとの一覧です。
...
　
<h2 id="商のfloorの値ごとに纏め上げ">357. 商のfloorの値ごとに纏め上げ</h2>
...
　
<h2 id="オイラー関数計算">358. オイラー関数計算</h2>
...
　
<h2 id="多重総和・総乗計算">360. 多重総和・総乗計算</h2>

### 難易度統計

「多重総和・総乗計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.8／diff <font color="yellowgreen">2112</font>
- 2024年: ★2.5／diff <font color="blue">1945</font>
...
　
<h2 id="冪等重みの最短経路長計算">361. 冪等重みの最短経路長計算</h2>
...
　
<h2 id="高さ奇数ニム和">362. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#高さ奇数ニム和">高さ奇数ニム和</a></h2>
...
　
<h2 id="調和数列による計算量評価">363. 調和数列による計算量評価</h2>

### 難易度統計

「調和数列による計算量評価」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.8／diff <font color="yellowgreen">2141</font>
- 2024年: ★2.5／diff <font color="blue">1680</font>
...
　
<h2 id="ナップサック割り当て数え上げ">364. ナップサック割り当て数え上げ</h2>

### 難易度統計

「ナップサック割り当て数え上げ」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.8／diff <font color="yellowgreen">2225</font>
- 2024年: ★2.8／diff <font color="yellowgreen">2039</font>
- 2023年: ★2.6／diff <font color="yellowgreen">2239</font>
...
　
<h2 id="最終手番の任意性">366. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#最終手番の任意性">最終手番の任意性</a></h2>
...
　
<h2 id="複数ナップサック最適化">367. 複数ナップサック最適化</h2>
...
　
<h2 id="タイリング・LightsOutの解の構築">369. タイリング・LightsOutの解の構築</h2>
...
　
<h2 id="行列の簡約階段化">371. 行列の簡約階段化</h2>
...
　
<h2 id="累積max・min">372. 累積max・min</h2>

### 難易度統計

「累積max・min」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.8／diff <font color="yellowgreen">2378</font>
- 2024年: ★2.8／diff <font color="orange">2448</font>
...
　
<h2 id="Convex Hull Trick">373. Convex Hull Trick</h2>
...
　
<h2 id="slope trick">374. slope trick</h2>
...
　
<h2 id="一次式の族の最大・最小値取得">375. 一次式の族の最大・最小値取得</h2>
...
　
<h2 id="解法場合分け">377. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#解法場合分け">解法場合分け</a></h2>
...
- 2024年: ★2.8／diff <font color="blue">1809</font>
...
　
<h2 id="約数の走査を倍数の走査に帰着">378. 約数の走査を倍数の走査に帰着</h2>
...
　
<h2 id="区間の分割を始切片の分割と終切片の組に翻訳して境目を管理する次元圧縮">379. 区間の分割を始切片の分割と終切片の組に翻訳して境目を管理する次元圧縮</h2>
...
　
<h2 id="総和計算を終切片の逆像の数え上げに帰着">382. 総和計算を終切片の逆像の数え上げに帰着</h2>

### 難易度統計

「総和計算を終切片の逆像の数え上げに帰着」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="deepskyblue">1406</font>
- 2024年: ★3／diff <font color="deepskyblue">1406</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="冪乗数である約数列挙">383. 冪乗数である約数列挙</h2>
...
　
<h2 id="閉路と残りに分割">385. 閉路と残りに分割</h2>
...
　
<h2 id="任意mod畳み込み">386. 任意mod畳み込み</h2>
...
　
<h2 id="中間値の定理">387. 中間値の定理</h2>

### 難易度統計

「中間値の定理」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="blue">1900</font>
- 2024年: ★3／diff <font color="blue">1900</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="凸関数の高々２対１性">388. 凸関数の高々２対１性</h2>

### 難易度統計

「凸関数の高々２対１性」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="blue">1900</font>
- 2024年: ★3／diff <font color="blue">1900</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
「凸関数の高々２対１性」を主たる解法に含む問題のレベルごとの一覧です。
...
　
<h2 id="01列とグリッド上の経路の対応">390. 01列とグリッド上の経路の対応</h2>

### 難易度統計

「01列とグリッド上の経路の対応」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="blue">1941</font>
...
　
<h2 id="最大流最小カット定理">393. 最大流最小カット定理</h2>
...
　
<h2 id="選択組み合わせ報酬付きナップサック最適化">394. 選択組み合わせ報酬付きナップサック最適化</h2>
...
　
<h2 id="モノイド演算に関する区間取得">396. モノイド演算に関する区間取得</h2>
...
　
<h2 id="素因数分解によるオイラー関数計算">402. 素因数分解によるオイラー関数計算</h2>
...
　
<h2 id="累積和・グリッド上のDPを経路数え上げに翻訳">403. 累積和・グリッド上のDPを経路数え上げに翻訳</h2>
...
　
<h2 id="木の頂点の深さ計算">404. 木の頂点の深さ計算</h2>
...
　
<h2 id="平方数の積への分解を用いた平方数判定">407. 平方数の積への分解を用いた平方数判定</h2>
...
　
<h2 id="内積の畳み込み計算">409. 内積の畳み込み計算</h2>
...
　
<h2 id="弾性衝突を通過に翻訳して位置関係から復元">411. 弾性衝突を通過に翻訳して位置関係から復元</h2>
...
　
<h2 id="木の頂点の重さ計算">412. 木の頂点の重さ計算</h2>
...
　
<h2 id="四角形を三角形２つや対角線２本に翻訳">413. 四角形を三角形２つや対角線２本に翻訳</h2>
...
　
<h2 id="ヤング図形の転置">414. ヤング図形の転置</h2>

### 難易度統計

「ヤング図形の転置」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="yellowgreen">2081</font>
- 2024年: ★3／diff <font color="yellowgreen">2081</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="ポラードの$\rho$">415. ポラードの$\rho$</h2>
...
　
<h2 id="分割数計算">416. 分割数計算</h2>

### 難易度統計

「分割数計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="yellowgreen">2107</font>
...
　
<h2 id="分割方法数え上げ">417. 分割方法数え上げ</h2>
...
　
<h2 id="最適遷移を自己写像に翻訳">418. 最適遷移を自己写像に翻訳</h2>
...
　
<h2 id="累積積による二項係数計算">419. 累積積による二項係数計算</h2>
...
　
<h2 id="カタランの三角形計算">421. カタランの三角形計算</h2>
...
　
<h2 id="二次元imos法">424. 二次元imos法</h2>
...
　
<h2 id="ファンデルモンドの畳み込み">426. ファンデルモンドの畳み込み</h2>
...
　
<h2 id="関数のグラフ形状の変化イベント走査による差分計算">427. 関数のグラフ形状の変化イベント走査による差分計算</h2>

### 難易度統計

「関数のグラフ形状の変化イベント走査による差分計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="yellowgreen">2148</font>
- 2024年: ★3／diff <font color="yellowgreen">2248</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★3／diff <font color="yellowgreen">2049</font>
...
　
<h2 id="最近共通祖先計算">428. 最近共通祖先計算</h2>
...
　
<h2 id="inplace DP">429. inplace DP</h2>

### 難易度統計

「inplace DP」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="yellowgreen">2164</font>
- 2024年: ★3／diff <font color="orange">2454</font>
- 2023年: ★2.6／diff <font color="blue">1821</font>
...
　
<h2 id="ゼータ変換">430. ゼータ変換</h2>

### 難易度統計

「ゼータ変換」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="yellowgreen">2166</font>
- 2024年: ★2.8／diff <font color="blue">1813</font>
...
　
<h2 id="総和計算の期待値への帰着">431. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#総和計算の期待値への帰着">総和計算の期待値への帰着</a></h2>
...
　
<h2 id="コーシー・フロベニウスの補題">433. コーシー・フロベニウスの補題</h2>
...
　
<h2 id="区間max・min取得">436. 区間max・min取得</h2>
...
　
<h2 id="剰余を商のfloorに翻訳">437. 剰余を商のfloorに翻訳</h2>
...
　
<h2 id="DPのデータ構造高速化">438. DPのデータ構造高速化</h2>

### 難易度統計

「DPのデータ構造高速化」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="yellowgreen">2206</font>
- 2024年: ★2.8／diff <font color="yellowgreen">2108</font>
- 2023年: ★3／diff <font color="yellowgreen">2193</font>
...
　
<h2 id="minimax法">440. minimax法</h2>
...
　
<h2 id="重複選択可ナップサック割り当て数え上げ">443. 重複選択可ナップサック割り当て数え上げ</h2>

### 難易度統計

「重複選択可ナップサック割り当て数え上げ」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="yellowgreen">2220</font>
- 2024年: ★3／diff <font color="yellowgreen">2125</font>
- 2023年: ★3／diff <font color="orange">2411</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="データ構造初期化">446. データ構造初期化</h2>
...
　
<h2 id="一対一対応と乱択の可換性">447. 一対一対応と乱択の可換性</h2>
...
　
<h2 id="重み付き木上の頂点間距離取得">449. 重み付き木上の頂点間距離取得</h2>
...
　
<h2 id="多次元コストナップサック割り当て数え上げ">453. 多次元コストナップサック割り当て数え上げ</h2>
...
　
<h2 id="複素共役による絶対値計算">455. 複素共役による絶対値計算</h2>
...
　
<h2 id="タイリング・LightsOut可能性判定を領域の細分による不変量計算に帰着">456. タイリング・LightsOut可能性判定を領域の細分による不変量計算に帰着</h2>
...
　
<h2 id="ベルトラン・チェビシェフの定理">457. ベルトラン・チェビシェフの定理</h2>
...
　
<h2 id="素数に注目する質問">458. 素数に注目する質問</h2>
...
　
<h2 id="対角線に言及する質問">459. 対角線に言及する質問</h2>
...
　
<h2 id="配列のリアクティブによる特定">460. 配列のリアクティブによる特定</h2>
...
　
<h2 id="グリッド上の価値最大化">461. グリッド上の価値最大化</h2>
...
　
<h2 id="矩形max・min取得">462. 矩形max・min取得</h2>
...
　
<h2 id="ローリングハッシュ">463. ローリングハッシュ</h2>
...
　
<h2 id="連続回数制約を分割の区間長制約に翻訳">464. 連続回数制約を分割の区間長制約に翻訳</h2>
...
　
<h2 id="小数型の許容誤差付き二分探索・二分法">466. 小数型の許容誤差付き二分探索・二分法</h2>

### 難易度統計

「小数型の許容誤差付き二分探索・二分法」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="yellowgreen">2351</font>
- 2024年: ★3.5／diff <font color="red">3143</font>
- 2023年: ★2.5／diff <font color="deepskyblue">1560</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="区間の部分列をわたる総和計算をモノイド演算に翻訳">467. 区間の部分列をわたる総和計算をモノイド演算に翻訳</h2>
...
　
<h2 id="Monotone Minima">468. Monotone Minima</h2>
...
　
<h2 id="座標のリアクティブによる特定">469. 座標のリアクティブによる特定</h2>
...
　
<h2 id="剰余を取る前に符号や大小を計算">470. 剰余を取る前に符号や大小を計算</h2>
...
　
<h2 id="bitset高速化">471. bitset高速化</h2>
...
　
<h2 id="平均の指定された区間数え上げ">474. 平均の指定された区間数え上げ</h2>
...
　
<h2 id="全方位木DP">475. 全方位木DP</h2>

### 難易度統計

「全方位木DP」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="yellowgreen">2392</font>
...
　
<h2 id="剰余の法を止めた総和計算">476. 剰余の法を止めた総和計算</h2>

### 難易度統計

「剰余の法を止めた総和計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
...
「剰余の法を止めた総和計算」を主たる解法に含む問題のレベルごとの一覧です。
...
　
<h2 id="二項係数・順列の第１引数を渡る総和計算">477. 二項係数・順列の第１引数を渡る総和計算</h2>
...
　
<h2 id="コストなしナップサック割り当て数え上げ">478. コストなしナップサック割り当て数え上げ</h2>

### 難易度統計

「コストなしナップサック割り当て数え上げ」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="orange">2411</font>
- 2024年: ★データなし／diffデータなし
- 2023年: ★3／diff <font color="orange">2411</font>
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="選択回数上限付き重複選択可ナップサック割り当て数え上げ">479. 選択回数上限付き重複選択可ナップサック割り当て数え上げ</h2>
...
　
<h2 id="複数価値ナップサック割り当て数え上げ">481. 複数価値ナップサック割り当て数え上げ</h2>
...
　
<h2 id="有理数の大小比較のオーバーフロー回避">484. 有理数の大小比較のオーバーフロー回避</h2>
...
　
<h2 id="完全二部マッチング">486. 完全二部マッチング</h2>
...
　
<h2 id="始切片選択ナップサック最適化">487. 始切片選択ナップサック最適化</h2>
...
　
<h2 id="単調関数の像計算を階差の非零点の数え上げに帰着">490. 単調関数の像計算を階差の非零点の数え上げに帰着</h2>
...
　
<h2 id="ワイルドカードの値を変数化">494. ワイルドカードの値を変数化</h2>
...
　
<h2 id="スタック">495. スタック</h2>

### 難易度統計

「スタック」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diff <font color="orange">2581</font>
- 2024年: ★3／diff <font color="orange">2581</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
　
<h2 id="連立一次不等式の充足可能性判定">498. 連立一次不等式の充足可能性判定</h2>
...
　
<h2 id="最小被覆半径計算">499. 最小被覆半径計算</h2>
...
　
<h2 id="1の原始根を用いた文字種シフトの実装">500. 1の原始根を用いた文字種シフトの実装</h2>

### 難易度統計

「1の原始根を用いた文字種シフトの実装」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3／diffデータなし
- 2024年: ★3／diffデータなし
- 2023年: ★データなし／diffデータなし
- 2022年: ★データなし／diffデータなし
...
「1の原始根を用いた文字種シフトの実装」を主たる解法に含む問題のレベルごとの一覧です。
...
　
<h2 id="部分列の二項関係をデータ構造で管理">501. 部分列の二項関係をデータ構造で管理</h2>
...
　
<h2 id="タイリングによるミラー戦略">502. タイリングによるミラー戦略</h2>
...
　
<h2 id="辺を頂点とするグラフに翻訳">503. 辺を頂点とするグラフに翻訳</h2>
...
　
<h2 id="制約からグラフの種類を特定">504. 制約からグラフの種類を特定</h2>
...
　
<h2 id="トポロジカルソート">505. トポロジカルソート</h2>
...
　
<h2 id="双対セグメント木">506. 双対セグメント木</h2>

### 難易度統計

「双対セグメント木」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3.1／diff <font color="yellowgreen">2218</font>
...
　
<h2 id="約数ゼータ変換">507. 約数ゼータ変換</h2>

### 難易度統計

「約数ゼータ変換」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3.1／diff <font color="yellowgreen">2305</font>
- 2024年: ★2.7／diff <font color="blue">1704</font>
...
　
<h2 id="メビウスの反転公式">509. メビウスの反転公式</h2>

### 難易度統計

「メビウスの反転公式」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3.1／diff <font color="yellowgreen">2325</font>
- 2024年: ★3／diff <font color="blue">1900</font>
- 2023年: ★3.1／diff <font color="orange">2473</font>
- 2022年: ★3／diff <font color="yellowgreen">2306</font>
...
　
<h2 id="最長共通接頭辞計算">512. 最長共通接頭辞計算</h2>
...
　
<h2 id="Moのアルゴリズム">513. Moのアルゴリズム</h2>
...
　
<h2 id="区間max・min更新">514. 区間max・min更新</h2>
...
　
<h2 id="十分大きな法で計算">515. 十分大きな法で計算</h2>
...
　
<h2 id="単位の分解">516. 単位の分解</h2>

### 難易度統計

「単位の分解」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3.2／diff <font color="yellowgreen">2292</font>
- 2024年: ★1.5／diff <font color="deepskyblue">1389</font>
...
　
<h2 id="指数と対数による冪乗計算">517. 指数と対数による冪乗計算</h2>
...
　
<h2 id="外積・サラスの公式による行列式計算">518. 外積・サラスの公式による行列式計算</h2>
...
　
<h2 id="行列式と面積・体積の関係">519. 行列式と面積・体積の関係</h2>
...
　
<h2 id="フロベニウス数に注目">520. フロベニウス数に注目</h2>
...
　
<h2 id="総和の指定された部分列数え上げ">524. 総和の指定された部分列数え上げ</h2>
...
　
<h2 id="集合族による帰属関係で類別">525. 集合族による帰属関係で類別</h2>
...
　
<h2 id="区間を中間で分割してマージ">527. 区間を中間で分割してマージ</h2>
...
　
<h2 id="約数メビウス変換">528. 約数メビウス変換</h2>

### 難易度統計

「約数メビウス変換」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3.2／diff <font color="orange">2504</font>
- 2024年: ★3／diff <font color="blue">1900</font>
- 2023年: ★3.5／diff <font color="red">2906</font>
- 2022年: ★3／diff <font color="yellowgreen">2306</font>
...
　
<h2 id="第二種スターリング数計算">529. 第二種スターリング数計算</h2>

### 難易度統計

「第二種スターリング数計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3.2／diff <font color="orange">2612</font>
- 2024年: ★3／diff <font color="orange">2581</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★3.5／diff <font color="orange">2643</font>
...
　
<h2 id="剰余による確率的判定">530. 剰余による確率的判定</h2>
...
　
<h2 id="分割統治法（狭義：devide-and-conquer）">532. 分割統治法（狭義：devide-and-conquer）</h2>

### 難易度統計

「分割統治法（狭義：devide-and-conquer）」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3.3／diff <font color="orange">2486</font>
- 2024年: ★2.2／diff <font color="blue">1850</font>
- 2023年: ★3.4／diff <font color="orange">2450</font>
- 2022年: ★3.8／diff <font color="red">2995</font>
...
　
<h2 id="桁DP">533. 桁DP</h2>

### 難易度統計

「桁DP」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3.3／diff <font color="orange">2557</font>
...
　
<h2 id="遅延セグメント木">536. 遅延セグメント木</h2>

### 難易度統計

「遅延セグメント木」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3.3／diff <font color="orange">2687</font>
- 2024年: ★3／diff <font color="yellowgreen">2340</font>
- 2023年: ★データなし／diffデータなし
...
　
<h2 id="区間一次式max・min更新">537. 区間一次式max・min更新</h2>
...
　
<h2 id="シュトルツ・チェザロの定理">538. シュトルツ・チェザロの定理</h2>
...
　
<h2 id="移動回数の期待値を距離で割った値の極限計算を平均移動速度に帰着">539. 移動回数の期待値を距離で割った値の極限計算を平均移動速度に帰着</h2>
...
　
<h2 id="掃き出し法による行列式計算">543. 掃き出し法による行列式計算</h2>
...
　
<h2 id="冪乗との最大公約数の収束">544. 冪乗との最大公約数の収束</h2>
...
　
<h2 id="cyclic orderつき全方位木DP">548. cyclic orderつき全方位木DP</h2>
...
　
<h2 id="低次項の追加による線形化">552. 低次項の追加による線形化</h2>
...
　
<h2 id="01列とヤング図形の対応">557. 01列とヤング図形の対応</h2>

### 難易度統計

「01列とヤング図形の対応」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★4／diff <font color="orange">2583</font>
- 2024年: ★3／diff <font color="yellowgreen">2081</font>
- 2023年: ★データなし／diffデータなし
- 2022年: ★5／diff <font color="red">3086</font>
...
　
<h2 id="01列と単調増加列・分割の対応">558. 01列と単調増加列・分割の対応</h2>
...
　
<h2 id="小さい法に帰着させる再帰">559. 小さい法に帰着させる再帰</h2>
...
　
<h2 id="高速フーリエ変換">560. 高速フーリエ変換</h2>
...
　
<h2 id="データ構造をマージする一般的なテク">561. データ構造をマージする一般的なテク</h2>
...
　
<h2 id="演算の反復の分割統治">562. 演算の反復の分割統治</h2>
...
　
<h2 id="ファウルハーバーの公式">563. ファウルハーバーの公式</h2>
...
　
<h2 id="parallel tree contraction">564. parallel tree contraction</h2>
...
　
<h2 id="演算の適用を一次式の合成に翻訳">565. 演算の適用を一次式の合成に翻訳</h2>
...
　
<h2 id="区間二次形式取得">568. 区間二次形式取得</h2>
...
　
<h2 id="Polynomial Taylor shift">570. Polynomial Taylor shift</h2>
...
　
<h2 id="Lindstrom-Gessel-Viennotの補題">571. Lindstrom-Gessel-Viennotの補題</h2>
...
　
<h2 id="ファンデルモンドの行列式計算">572. ファンデルモンドの行列式計算</h2>
...
　
<h2 id="半標準ヤングタブローとGelfand-Tsetlinパターンの対応">574. 半標準ヤングタブローとGelfand-Tsetlinパターンの対応</h2>
...
　
<h2 id="半標準ヤングタブローと非交差経路の対応">575. 半標準ヤングタブローと非交差経路の対応</h2>
...
　
<h2 id="半標準ヤングタブローに翻訳">576. 半標準ヤングタブローに翻訳</h2>
...
　
<h2 id="標準ヤングタブローに翻訳">579. 標準ヤングタブローに翻訳</h2>
...
　
<h2 id="Bostan-Mori法">581. Bostan-Mori法</h2>
...
　
<h2 id="多項式のユークリッドの互除法">583. 多項式のユークリッドの互除法</h2>
...
　
<h2 id="多項式を法とする逆元計算">584. 多項式を法とする逆元計算</h2>
...
　
<h2 id="一次分数変換と対数関数による変数変換の合成">587. 一次分数変換と対数関数による変数変換の合成</h2>
...
　
<h2 id="指数関数による変数変換と一次分数変換の合成">588. 指数関数による変数変換と一次分数変換の合成</h2>
...
　
<h2 id="微分作用素を変数変換で簡易化">589. 微分作用素を変数変換で簡易化</h2>
...
　
<h2 id="残余ネットワーク">591. 残余ネットワーク</h2>
...
　
<h2 id="B進法位取り記法と法Bベクトルの変換">592. B進法位取り記法と法Bベクトルの変換</h2>
...
　
<h2 id="区間一次式加算更新">596. 区間一次式加算更新</h2>
