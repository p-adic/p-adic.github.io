...
通常問題の問題番号2056から2612までと2953以降を登録し終わりました。先は長いです。
...
1. （★1.2／diff <font color="brown">621</font>／36問）<a href="#実装" class="tag">実装</a>
1. （★1.2／diff <font color="brown">704</font>／2問）<a href="#カレンダー計算" class="tag">カレンダー計算</a>
1. （★1.3／diff <font color="brown">772</font>／9問）<a href="#数値の文字列受け取り" class="tag">数値の文字列受け取り</a>
...
1. （★1.5／diff <font color="green">988</font>／3問）<a href="#等差数列の累積和計算" class="tag">等差数列の累積和計算</a>
...
1. （★2／diff <font color="deepskyblue">1461</font>／60問）<a href="#全探索" class="tag">全探索</a>
...
1. （★2.1／diff <font color="deepskyblue">1495</font>／22問）<a href="#貪欲法" class="tag">貪欲法</a>
1. （★2.1／diff <font color="deepskyblue">1499</font>／44問）<a href="#場合分け" class="tag">場合分け</a>
...
1. （★2.1／diff <font color="deepskyblue">1590</font>／8問）<a href="#小数計算の整数への帰着" class="tag">小数計算の整数への帰着</a>
...
1. （★2.3／diff <font color="blue">1739</font>／28問）<a href="#変数決め打ち" class="tag">変数決め打ち</a>
...
1. （★2.4／diff <font color="blue">1708</font>／11問）<a href="#不変量に注目" class="tag">不変量に注目</a>
1. （★2.4／diff <font color="blue">1762</font>／67問）<a href="#剰余計算" class="tag">剰余計算</a>
1. （★2.4／diff <font color="blue">1810</font>／6問）<a href="#階差数列" class="tag">階差数列</a>
1. （★2.4／diff <font color="blue">1825</font>／26問）<a href="#ソート" class="tag">ソート</a>
...
1. （★2.5／diff <font color="blue">1841</font>／28問）<a href="#二分探索" class="tag">二分探索</a>
...
1. （★2.5／diff <font color="blue">1879</font>／21問、[解説ページ](https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#損をしない変形)）<a href="#損をしない変形" class="tag">損をしない変形</a>
...
1. （★2.5／diff <font color="blue">1923</font>／16問）<a href="#集合管理" class="tag">集合管理</a>
...
1. （★3／diff <font color="orange">2604</font>／1問）<a href="#区間の部分列をわたる総和計算をモノイド演算に翻訳" class="tag">区間の部分列をわたる総和計算をモノイド演算に翻訳</a>
...
1. （★3.3／diff <font color="yellowgreen">2378</font>／5問）<a href="#小さいケースの構築を拡張" class="tag">小さいケースの構築を拡張</a>
...
- 全体: ★1.2／diff <font color="brown">621</font>
...
- 全体: ★1.3／diff <font color="brown">772</font>
- 2024年: ★1.7／diff <font color="deepskyblue">1505</font>
...
　
<h2 id="等差数列の累積和計算">16. 等差数列の累積和計算</h2>

### 難易度統計

「等差数列の累積和計算」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★1.5／diff <font color="green">988</font>
...
　
<h2 id="決め打ちによる構築">23. 決め打ちによる構築</h2>
...
　
<h2 id="重複選択可ナップサック最適化">28. 重複選択可ナップサック最適化</h2>
...
　
<h2 id="多項係数と組み合わせの関係">40. 多項係数と組み合わせの関係</h2>
...
- 全体: ★2／diff <font color="deepskyblue">1461</font>
- 2024年: ★2.2／diff <font color="blue">1830</font>
...
　
<h2 id="１次式の最大・最小化">49. １次式の最大・最小化</h2>
...
　
<h2 id="剰余計算を桁の線形和に帰着">50. 剰余計算を桁の線形和に帰着</h2>
...
　
<h2 id="ナップサック最適化">51. ナップサック最適化</h2>
...
　
<h2 id="等比数列の累積和計算">52. 等比数列の累積和計算</h2>
...
　
<h2 id="多次元コストナップサック最適化">53. 多次元コストナップサック最適化</h2>
...
　
<h2 id="操作を数値に翻訳">54. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#操作を数値に翻訳">操作を数値に翻訳</a></h2>
...
- 2024年: ★3／diff <font color="orange">2560</font>
...
- 全体: ★2.1／diff <font color="deepskyblue">1499</font>
- 2024年: ★2.1／diff <font color="deepskyblue">1480</font>
...
　
<h2 id="小数計算の整数への帰着">59. 小数計算の整数への帰着</h2>

### 難易度統計

「小数計算の整数への帰着」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.1／diff <font color="deepskyblue">1590</font>
- 2024年: ★2.7／diff <font color="yellowgreen">2180</font>
...
　
<h2 id="マッチ度ごとに管理">79. マッチ度ごとに管理</h2>
...
- 全体: ★2.3／diff <font color="blue">1739</font>
- 2024年: ★2.6／diff <font color="yellowgreen">2083</font>
...
　
<h2 id="アルゴリズムのリアクティブ化">92. アルゴリズムのリアクティブ化</h2>
...
　
<h2 id="階乗による二項係数の明示式">93. 階乗による二項係数の明示式</h2>
...
- 全体: ★2.4／diff <font color="blue">1708</font>
- 2024年: ★3／diff <font color="orange">2536</font>
...
　
<h2 id="階差数列">98. 階差数列</h2>

### 難易度統計

「階差数列」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★2.4／diff <font color="blue">1810</font>
- 2024年: ★3／diff <font color="orange">2536</font>
...
- 全体: ★2.4／diff <font color="blue">1825</font>
- 2024年: ★3／diff <font color="orange">2560</font>
...
- 全体: ★2.5／diff <font color="blue">1841</font>
...
- 全体: ★2.5／diff <font color="blue">1879</font>
- 2024年: ★3／diff <font color="orange">2560</font>
...
　
<h2 id="素数列による試し割り法">146. 素数列による試し割り法</h2>
...
　
<h2 id="指定序数の値の計算を始切片の数え上げに帰着">147. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#指定序数の値の計算を始切片の数え上げに帰着">指定序数の値の計算を始切片の数え上げに帰着</a></h2>
...
　
<h2 id="１次式の累積和計算">149. １次式の累積和計算</h2>
...
- 2024年: ★2／diff <font color="blue">1827</font>
...
　
<h2 id="素数を法とする逆元計算">173. 素数を法とする逆元計算</h2>
...
　
<h2 id="距離空間の重み付きグラフ化">175. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#距離空間の重み付きグラフ化">距離空間の重み付きグラフ化</a></h2>
...
　
<h2 id="素数を用いた構築">176. 素数を用いた構築</h2>
...
　
<h2 id="フェルマーの小定理による逆元の明示式">178. フェルマーの小定理による逆元の明示式</h2>
...
　
<h2 id="オイラー関数計算">181. オイラー関数計算</h2>
...
　
<h2 id="最大・最小要素削除">182. 最大・最小要素削除</h2>
...
　
<h2 id="ナップサック割り当て数え上げ">185. ナップサック割り当て数え上げ</h2>
...
　
<h2 id="サンプルから推測">186. サンプルから推測</h2>
...
　
<h2 id="閉路と残りに分割">226. 閉路と残りに分割</h2>
...
　
<h2 id="inplace DP">233. inplace DP</h2>
...
　
<h2 id="区間スケジューリング">234. 区間スケジューリング</h2>
...
　
<h2 id="弾性衝突を通過に翻訳して位置関係から復元">241. 弾性衝突を通過に翻訳して位置関係から復元</h2>
...
　
<h2 id="木の頂点の重さ計算">242. 木の頂点の重さ計算</h2>
...
　
<h2 id="区間最大・最小値取得">243. 区間最大・最小値取得</h2>
...
　
<h2 id="始点と終点からの経路計算">245. 始点と終点からの経路計算</h2>
...
　
<h2 id="区間の分割の数え上げを切片の分割に帰着">247. 区間の分割の数え上げを切片の分割に帰着</h2>
...
　
<h2 id="総和計算の期待値への帰着">249. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#総和計算の期待値への帰着">総和計算の期待値への帰着</a></h2>
...
　
<h2 id="最適遷移の写像化">250. 最適遷移の写像化</h2>
...
　
<h2 id="２次元imos法">251. ２次元imos法</h2>
...
　
<h2 id="ユークリッドの互除法">253. ユークリッドの互除法</h2>
...
　
<h2 id="区間の重複度計算">255. 区間の重複度計算</h2>
...
　
<h2 id="グリッド上の価値最大化">256. グリッド上の価値最大化</h2>
...
　
<h2 id="コーシー・フロベニウスの補題">257. コーシー・フロベニウスの補題</h2>
...
　
<h2 id="解法場合分け">260. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#解法場合分け">解法場合分け</a></h2>
...
　
<h2 id="データ構造初期化">262. データ構造初期化</h2>
...
　
<h2 id="一対一対応と乱択の可換性">263. 一対一対応と乱択の可換性</h2>
...
　
<h2 id="bitset高速化">264. bitset高速化</h2>
...
　
<h2 id="内積の畳み込み計算">267. 内積の畳み込み計算</h2>
...
　
<h2 id="floor_sum">268. floor_sum</h2>
...
　
<h2 id="行列式と面積・体積の関係">269. 行列式と面積・体積の関係</h2>
...
　
<h2 id="ベルトラン・チェビシェフの定理">270. ベルトラン・チェビシェフの定理</h2>
...
　
<h2 id="素数に注目する質問">271. 素数に注目する質問</h2>
...
　
<h2 id="対角線に言及する質問">272. 対角線に言及する質問</h2>
...
　
<h2 id="平均の指定された区間数え上げ">277. 平均の指定された区間数え上げ</h2>
...
　
<h2 id="緩和">279. <a href="https://p-adic.github.io/yukicoder-difficulty-statistics-solution-name/#緩和">緩和</a></h2>
...
　
<h2 id="有理数の大小比較のオーバーフロー回避">282. 有理数の大小比較のオーバーフロー回避</h2>
...
　
<h2 id="単調関数の像計算を階差の非零点の数え上げに帰着">288. 単調関数の像計算を階差の非零点の数え上げに帰着</h2>
...
　
<h2 id="区間の部分列をわたる総和計算をモノイド演算に翻訳">294. 区間の部分列をわたる総和計算をモノイド演算に翻訳</h2>
...
　
<h2 id="最小被覆半径計算">296. 最小被覆半径計算</h2>
...
　
<h2 id="タイリングによるミラー戦略">297. タイリングによるミラー戦略</h2>
...
　
<h2 id="区間の部分列の数え上げをモノイド演算に翻訳">298. 区間の部分列の数え上げをモノイド演算に翻訳</h2>
...
　
<h2 id="辺を頂点とするグラフに翻訳">299. 辺を頂点とするグラフに翻訳</h2>
...
　
<h2 id="始切片の数え上げを桁ごとの計算に帰着">301. 始切片の数え上げを桁ごとの計算に帰着</h2>
...
　
<h2 id="DPのデータ構造高速化">304. DPのデータ構造高速化</h2>
...
　
<h2 id="最長共通接頭辞計算">310. 最長共通接頭辞計算</h2>
...
　
<h2 id="フロベニウス数に注目">312. フロベニウス数に注目</h2>
...
　
<h2 id="十分大きな法で計算">317. 十分大きな法で計算</h2>
...
　
<h2 id="剰余による確率的判定">319. 剰余による確率的判定</h2>
...
　
<h2 id="小さいケースの構築を拡張">320. 小さいケースの構築を拡張</h2>

### 難易度統計

「小さいケースの構築を拡張」を主たる解法に含む問題の難易度統計（コンテスト平均レベル／コンテスト平均difficulty）です。
- 全体: ★3.3／diff <font color="yellowgreen">2378</font>
- 2024年: ★3／diff <font color="orange">2494</font>
- 2023年: ★データなし／diffデータなし
...
　
<h2 id="約数メビウス変換">324. 約数メビウス変換</h2>
...
　
<h2 id="シュトルツ・チェザロの定理">326. シュトルツ・チェザロの定理</h2>
...
　
<h2 id="移動回数の期待値を距離で割った値の極限計算を平均移動速度に帰着">327. 移動回数の期待値を距離で割った値の極限計算を平均移動速度に帰着</h2>
...
　
<h2 id="整礎な操作の試行回数の期待値を各状態への到達確率の和に帰着">328. 整礎な操作の試行回数の期待値を各状態への到達確率の和に帰着</h2>
...
　
<h2 id="Moのアルゴリズム">329. Moのアルゴリズム</h2>
...
　
<h2 id="ポラードの$\rho$">334. ポラードの$\rho$</h2>
...
　
<h2 id="メビウスの反転公式">338. メビウスの反転公式</h2>
...
　
<h2 id="冪乗との最大公約数の収束">339. 冪乗との最大公約数の収束</h2>
...
　
<h2 id="第二種スターリング数計算">340. 第二種スターリング数計算</h2>
...
　
<h2 id="行列の簡約階段化">345. 行列の簡約階段化</h2>
...
　
<h2 id="タイリング可能性を領域の細分による不変量計算に帰着">346. タイリング可能性を領域の細分による不変量計算に帰着</h2>
...
　
<h2 id="cyclic orderつき全方位木DP">348. cyclic orderつき全方位木DP</h2>
...
　
<h2 id="最近共通祖先計算">352. 最近共通祖先計算</h2>
...
　
<h2 id="小さい法に帰着させる再帰">356. 小さい法に帰着させる再帰</h2>
...
　
<h2 id="区間最大・最小値更新">358. 区間最大・最小値更新</h2>
...
　
<h2 id="高速フーリエ変換">361. 高速フーリエ変換</h2>
...
　
<h2 id="遅延セグメント木">365. 遅延セグメント木</h2>
...
　
<h2 id="データ構造をマージする一般的なテク">366. データ構造をマージする一般的なテク</h2>
...
　
<h2 id="演算の反復の分割統治">367. 演算の反復の分割統治</h2>
...
　
<h2 id="ファウルハーバーの公式">368. ファウルハーバーの公式</h2>
...
　
<h2 id="parallel tree contraction">369. parallel tree contraction</h2>
...
　
<h2 id="演算の適用を１次式の合成に翻訳">370. 演算の適用を１次式の合成に翻訳</h2>
...
　
<h2 id="区間二次形式取得">373. 区間二次形式取得</h2>
...
　
<h2 id="Polynomial Taylor shift">375. Polynomial Taylor shift</h2>
...
　
<h2 id="Lindstrom-Gessel-Viennotの補題">376. Lindstrom-Gessel-Viennotの補題</h2>
...
　
<h2 id="ファンデルモンドの行列式計算">377. ファンデルモンドの行列式計算</h2>
...
　
<h2 id="半標準ヤングタブロー">379. 半標準ヤングタブロー</h2>
...
　
<h2 id="半標準ヤングタブローとGelfand-Tsetlinパターンの対応">380. 半標準ヤングタブローとGelfand-Tsetlinパターンの対応</h2>
...
　
<h2 id="半標準ヤングタブローと非交差経路の対応">381. 半標準ヤングタブローと非交差経路の対応</h2>
...
　
<h2 id="標準ヤングタブロー">384. 標準ヤングタブロー</h2>
...
　
<h2 id="Bostan-Mori法">386. Bostan-Mori法</h2>
...
　
<h2 id="多項式のユークリッドの互除法">388. 多項式のユークリッドの互除法</h2>
...
　
<h2 id="多項式を法とする逆元計算">389. 多項式を法とする逆元計算</h2>
...
　
<h2 id="一次分数変換と対数関数による変数変換の合成">392. 一次分数変換と対数関数による変数変換の合成</h2>
...
　
<h2 id="指数関数による変数変換と一次分数変換の合成">393. 指数関数による変数変換と一次分数変換の合成</h2>
...
　
<h2 id="微分作用素を変数変換で簡易化">394. 微分作用素を変数変換で簡易化</h2>
...
　
<h2 id="トポロジカルソート">396. トポロジカルソート</h2>
...
　
<h2 id="残余ネットワーク">398. 残余ネットワーク</h2>
...
　
<h2 id="指定序数の値の計算を桁ごとの計算に帰着">399. 指定序数の値の計算を桁ごとの計算に帰着</h2>
...
　
<h2 id="非負整数をB進法でベクトルに翻訳">400. 非負整数をB進法でベクトルに翻訳</h2>
...
　
<h2 id="ハミルトン路構築">403. ハミルトン路構築</h2>
