...
1. 白紙のcppファイルを用意し、それを$$c$$と置く。$$c$$の存在するカレントディレクトリから$$r$$への相対パスを`RP`と置く。例えば$$r$$がカレントディレクトリに存在する場合は`RP`が`.`であり、$$r$$がカレントディレクトリの親ディレクトリに存在する場合は`RP`が`..`であり、$$r$$がカレントディレクトリの子ディレクトリ`child`に存在する場合は`RP`が`./child`である。
1. $$c$$に`RP/Mathematics/Function/Computable/a.hpp`をインクルードし、適宜改行をする。
...
1. $$c$$を$$G$$で十分新しい標準ライブラリ（例えば`-std=gnu++1z`）指定の下でコンパイルし、以下の手順でライブラリをリンクすることで生成される実行ファイルを$$e$$と置く。
  1. OSがWindowsの場合、オブジェクトファイル群`RP/Error/BreakPoint/a.o RP/Error/FaultInCoding/a.o RP/Error/IllegalAccess/a.o RP/Error/IllegalCall/a.o RP/Error/IllegalImput/a.o RP/Error/MismatchType/a.o RP/Error/Position/a.o RP/Error/Warning/a.o RP/Error/a.o RP/Utility/String/a.o RP/Mathematics/Arithmetic/Prime/a.o RP/Mathematics/Function/Computable/Expression/Primitive/bool/a.o RP/Mathematics/Function/Computable/Expression/Primitive/int/a.o RP/Mathematics/Function/Computable/Expression/Primitive/string/a.o RP/Mathematics/Function/Computable/Operator/Basic/bool/a.o RP/Mathematics/Function/Computable/Syntax/Translation/a.o RP/Mathematics/Function/Computable/Syntax/a.o RP/Mathematics/Function/Computable/Type/a.o`をリンクする。
