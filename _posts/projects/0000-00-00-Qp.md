...
1. 以下のurlからzipファイルをダウンロードし、それを解凍して得られるフォルダを$$r$$と置く。
    1. Windowsユーザーは[$$\mathbb{Q}_p$$ライブラリ](https://github.com/p-adic/cpp/Mathematics/Function/Computable/Library/libqp.zip)からダウンロードする。
    1. 非Windowsユーザーは[このレポジトリ](https://github.com/p-adic/cpp)全体を「Clone or Download」からダウンロードする。
