...
1. WindowsユーザーかつGCCユーザーは`RP/libqp.hpp`の代わりに`RP/libqpc++.hpp`をインクルードし、
1. 非Windowsユーザーまたは非GCCユーザーは`RP/cpp/Mathematics/Function/Computable/a.hpp`の代わりに`RP/cpp/Mathematics/Function/Computable/Library/cpp/a.hpp`をインクルードし、
