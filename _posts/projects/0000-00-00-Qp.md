...
<table border="1" cellpadding="5">
	...
	<tr>
		<td align="center">
 		...
 		<td>
 			<span class="code-css"><code> (s,n) </code></span>に対し<span class="code-css"><code> s </code></span>の始切片であって長さが<span class="code-css"><code> 1+n </code></span>であるものを返します。 
		</td>
	...
	<tr>
		<td align="center">
 		...
 		<td>
 			<span class="code-css"><code> (s,n) </code></span>に対し<span class="code-css"><code> s </code></span>の終切片であって長さが<span class="code-css"><code> 1+n </code></span>であるものを返します。 
		</td>
