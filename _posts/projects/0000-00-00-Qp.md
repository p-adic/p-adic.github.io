...
<tr>
  ...
  <tr>
		...
		<td align="center">
 		...
 		<td>
			本当は<span class="code-css"><code> TO </code></span>の中置記法に<span class="code-css"><code> -> </code></span>を、<span class="code-css"><code> EQUIV </code></span>の中置記法に<span class="code-css"><code> <=> </code></span>を採用したいのですが、これらはC++においてオーバーロードが制限されているため、C++コンパイラでコンパイルできるようにするためにこれらを採用することが出来ませんでした。 
		</td>
...
<table border="1" cellpadding="5">
	...
	<tr>
		<td align="center">
 		...
 		<td align="center">
 			...
 			<span class="code-css"><code> (ARRAY(T))->nat </code></span> <br>
 			<span class="code-css"><code> (NEST(T))->nat </code></span> 
		</td>
 		<td>
 			<span class="code-css"><code> s </code></span>に対し<span class="code-css"><code> s </code></span>の長さを返します。ただし<span class="code-css"><code> DENESTABLE( a ) </code></span>を満たす<span class="code-css"><code> NEST(T) </code></span>型の表現<span class="code-css"><code> a </code></span>に対する<span class="code-css"><code> LENGTH(a) </code></span>は<span class="code-css"><code> 0 </code></span>と定義されるのではなく未定義です。 
		</td>
	...
	<tr>
		<td align="center">
 		...
 		<td align="center">
 			...
 			<span class="code-css"><code> (ARRAY(T),nat)->T </code></span> <br>
 			<span class="code-css"><code> (NEST(T),nat)->NEST(T) </code></span> 
		</td>
 		<td>
	...
	<tr>
		<td align="center">
 		...
 		<td align="center">
 			...
 			<span class="code-css"><code> (ARRAY(T),nat)->ARRAY(T) </code></span> <br>
			<span class="code-css"><code> (NEST(T),nat)->NEST(T) </code></span> 
		</td>
 		<td>
	...
	<tr>
		<td align="center">
 		...
 		<td align="center">
 			<span class="code-css"><code> (T)->ARRAY(T) </code></span> 
		</td>
 		<td>
	...
	<tr>
		<td align="center">
 		...
 		<td align="center">
 			<span class="code-css"><code> (NEST(T))->NEST(T) </code></span> 
		</td>
 		<td>
	...
	<tr>
		<td align="center">
 		...
 		<td align="center">
 			<span class="code-css"><code> (T)->NEST(T) </code></span> 
		</td>
 		<td>
	...
	<tr>
		<td align="center">
 		...
 		<td align="center">
 			<span class="code-css"><code> (NEST(T))->T </code></span> 
		</td>
 		<td>
	...
	<tr>
		<td align="center">
 		...
 		<td align="center">
 			<span class="code-css"><code> (ARRAY(T))->NEST(T) </code></span> <br> <span class="code-css"><code> NEST(T)->NEST(T) </code></span> 
		</td>
 		<td>
 			<span class="code-css"><code> a </code></span>に対し<span class="code-css"><code> a </code></span>自身を返します。 
		</td>
...
<table border="1" cellpadding="5">
	...
	<tr>
		...
		<td align="center"> 
			高階型<span class="code-css"><code> (nat)->T </code></span>の演算子<span class="code-css"><code> f </code></span>と<span class="code-css"><code> nat </code></span>型の変数<span class="code-css"><code> n </code></span>に対し、写像<span class="code-css"><code> n \mapsto (f(i))_{i=0}^{n-1} </code></span>に対応する高階型<span class="code-css"><code> (nat)->ARRAY(T) </code></span>の関数<span class="code-css"><code> ARRAYISE(f,n) </code></span>を生成します。
		</td>
	</tr>
	<tr>
		<td align="center"> 
		...
		<td align="center"> 
			<span class="code-css"><code> nat </code></span>または<span class="code-css"><code> string </code></span>である型<span class="code-css"><code> T0 </code></span>に対し、<span class="code-css"><code> T0 </code></span>型の変数<span class="code-css"><code> n </code></span>と高階型<span class="code-css"><code> (T0,T1,…,Tn)->bool </code></span>の関係<span class="code-css"><code> r </code></span>に対し、関係<span class="code-css"><code> \exists x_0 \leq n, r(x_0,x_1,\ldots,x_n) </code></span>に対応する高階型<span class="code-css"><code> (T1,…,T_n)->bool </code></span>の関係<span class="code-css"><code> EXISTS(n,r) </code></span>を生成します。
		</td>
	</tr>
	<tr>
		<td align="center"> 
		...
		<td align="center"> 
			<span class="code-css"><code> nat </code></span>または<span class="code-css"><code> string </code></span>である型<span class="code-css"><code> T0 </code></span>に対し、<span class="code-css"><code> T0 </code></span>型の変数<span class="code-css"><code> n </code></span>と高階型<span class="code-css"><code> (T0,T1,…,Tn)->bool </code></span>の関係<span class="code-css"><code> r </code></span>に対し、関係<span class="code-css"><code> \exists ! x_0 \leq n, r(x_0,x_1,\ldots,x_n) </code></span>に対応する高階型<span class="code-css"><code> (T1,…,T_n)->bool </code></span>の関係<span class="code-css"><code> UEXISTS(n,r) </code></span>を生成します。
		</td>
	</tr>
</table>
