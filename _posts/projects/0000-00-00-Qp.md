...
<table border="1" cellpadding="5">
	...
	<tr>
		...
		<td align="center"> 
			高階型<span class="code-css"><code> (nat)->T </code></span>の演算子<span class="code-css"><code> f </code></span>と<span class="code-css"><code> nat </code></span>型の変数<span class="code-css"><code> n </code></span>に対し、<span class="code-css"><code> n </code></span>に対し<span class="code-css"><code> (f(0),…,f(n-1)) </code></span>を返す高階型<span class="code-css"><code> (nat)->ARRAY(T) </code></span>の関数<span class="code-css"><code> ARRAYISE(f,n) </code></span>を生成します。
		</td>
	</tr>
	<tr>
		<td align="center"> 
